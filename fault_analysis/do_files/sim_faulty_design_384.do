...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/21_0.v"
...
coverage save results/coverage_arbiter_384.ucdb
vcover report -assert -detail -output results/assertion_report_det_384.txt results/coverage_arbiter_384.ucdb
