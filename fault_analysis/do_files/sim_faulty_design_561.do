...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/17_1.v"
...
coverage save results/coverage_arbiter_561.ucdb
vcover report -assert -detail -output results/assertion_report_det_561.txt results/coverage_arbiter_561.ucdb
