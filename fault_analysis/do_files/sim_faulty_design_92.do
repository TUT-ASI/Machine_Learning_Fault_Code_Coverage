...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/146_3.v"
...
coverage save results/coverage_arbiter_92.ucdb
vcover report -assert -detail -output results/assertion_report_det_92.txt results/coverage_arbiter_92.ucdb
