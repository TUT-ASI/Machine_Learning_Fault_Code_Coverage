...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/78_0.v"
...
coverage save results/coverage_arbiter_359.ucdb
vcover report -assert -detail -output results/assertion_report_det_359.txt results/coverage_arbiter_359.ucdb
