...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/43_1.v"
...
coverage save results/coverage_arbiter_66.ucdb
vcover report -assert -detail -output results/assertion_report_det_66.txt results/coverage_arbiter_66.ucdb
