...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/97_1.v"
...
coverage save results/coverage_arbiter_75.ucdb
vcover report -assert -detail -output results/assertion_report_det_75.txt results/coverage_arbiter_75.ucdb
