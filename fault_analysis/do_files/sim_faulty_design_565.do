...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/96_2.v"
...
coverage save results/coverage_arbiter_565.ucdb
vcover report -assert -detail -output results/assertion_report_det_565.txt results/coverage_arbiter_565.ucdb
