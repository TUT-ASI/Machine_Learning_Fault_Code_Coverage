...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/42_1.v"
...
coverage save results/coverage_arbiter_147.ucdb
vcover report -assert -detail -output results/assertion_report_det_147.txt results/coverage_arbiter_147.ucdb
