...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/96_0.v"
...
coverage save results/coverage_arbiter_652.ucdb
vcover report -assert -detail -output results/assertion_report_det_652.txt results/coverage_arbiter_652.ucdb
