...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/78_3.v"
...
coverage save results/coverage_arbiter_467.ucdb
vcover report -assert -detail -output results/assertion_report_det_467.txt results/coverage_arbiter_467.ucdb
