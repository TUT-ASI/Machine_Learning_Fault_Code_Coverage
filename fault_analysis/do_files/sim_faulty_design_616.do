...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/25_1.v"
...
coverage save results/coverage_arbiter_616.ucdb
vcover report -assert -detail -output results/assertion_report_det_616.txt results/coverage_arbiter_616.ucdb
