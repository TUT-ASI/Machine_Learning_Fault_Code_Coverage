...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/57_2.v"
...
coverage save results/coverage_arbiter_208.ucdb
vcover report -assert -detail -output results/assertion_report_det_208.txt results/coverage_arbiter_208.ucdb
