...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/63_2.v"
...
coverage save results/coverage_arbiter_482.ucdb
vcover report -assert -detail -output results/assertion_report_det_482.txt results/coverage_arbiter_482.ucdb
