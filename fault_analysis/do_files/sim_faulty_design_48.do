...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/129_2.v"
...
coverage save results/coverage_arbiter_48.ucdb
vcover report -assert -detail -output results/assertion_report_det_48.txt results/coverage_arbiter_48.ucdb
