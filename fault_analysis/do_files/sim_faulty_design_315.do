...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/64_1.v"
...
coverage save results/coverage_arbiter_315.ucdb
vcover report -assert -detail -output results/assertion_report_det_315.txt results/coverage_arbiter_315.ucdb
