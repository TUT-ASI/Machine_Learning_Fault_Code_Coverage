...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/88_0.v"
...
coverage save results/coverage_arbiter_136.ucdb
vcover report -assert -detail -output results/assertion_report_det_136.txt results/coverage_arbiter_136.ucdb
