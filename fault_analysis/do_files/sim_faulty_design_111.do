...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/97_5.v"
...
coverage save results/coverage_arbiter_111.ucdb
vcover report -assert -detail -output results/assertion_report_det_111.txt results/coverage_arbiter_111.ucdb
