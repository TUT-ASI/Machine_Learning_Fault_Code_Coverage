...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/118_1.v"
...
coverage save results/coverage_arbiter_379.ucdb
vcover report -assert -detail -output results/assertion_report_det_379.txt results/coverage_arbiter_379.ucdb
