...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/64_5.v"
...
coverage save results/coverage_arbiter_309.ucdb
vcover report -assert -detail -output results/assertion_report_det_309.txt results/coverage_arbiter_309.ucdb
