...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/100_3.v"
...
coverage save results/coverage_arbiter_446.ucdb
vcover report -assert -detail -output results/assertion_report_det_446.txt results/coverage_arbiter_446.ucdb
