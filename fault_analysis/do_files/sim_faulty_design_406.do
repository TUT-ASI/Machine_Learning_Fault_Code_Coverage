...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/83_5.v"
...
coverage save results/coverage_arbiter_406.ucdb
vcover report -assert -detail -output results/assertion_report_det_406.txt results/coverage_arbiter_406.ucdb
