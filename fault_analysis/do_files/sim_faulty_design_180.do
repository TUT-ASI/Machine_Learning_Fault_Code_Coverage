...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/34_1.v"
...
coverage save results/coverage_arbiter_180.ucdb
vcover report -assert -detail -output results/assertion_report_det_180.txt results/coverage_arbiter_180.ucdb
