...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/58_6.v"
...
coverage save results/coverage_arbiter_574.ucdb
vcover report -assert -detail -output results/assertion_report_det_574.txt results/coverage_arbiter_574.ucdb
