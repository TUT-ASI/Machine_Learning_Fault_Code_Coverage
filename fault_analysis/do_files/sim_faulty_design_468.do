...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/49_1.v"
...
coverage save results/coverage_arbiter_468.ucdb
vcover report -assert -detail -output results/assertion_report_det_468.txt results/coverage_arbiter_468.ucdb
