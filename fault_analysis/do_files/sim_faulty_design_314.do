...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/54_2.v"
...
coverage save results/coverage_arbiter_314.ucdb
vcover report -assert -detail -output results/assertion_report_det_314.txt results/coverage_arbiter_314.ucdb
