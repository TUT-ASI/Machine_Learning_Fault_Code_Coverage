...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/60_2.v"
...
coverage save results/coverage_arbiter_138.ucdb
vcover report -assert -detail -output results/assertion_report_det_138.txt results/coverage_arbiter_138.ucdb
