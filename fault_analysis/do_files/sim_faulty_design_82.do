...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/51_0.v"
...
coverage save results/coverage_arbiter_82.ucdb
vcover report -assert -detail -output results/assertion_report_det_82.txt results/coverage_arbiter_82.ucdb
