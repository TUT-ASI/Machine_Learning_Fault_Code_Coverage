...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/85_0.v"
...
coverage save results/coverage_arbiter_103.ucdb
vcover report -assert -detail -output results/assertion_report_det_103.txt results/coverage_arbiter_103.ucdb
