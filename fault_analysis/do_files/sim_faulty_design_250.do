...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/35_2.v"
...
coverage save results/coverage_arbiter_250.ucdb
vcover report -assert -detail -output results/assertion_report_det_250.txt results/coverage_arbiter_250.ucdb
