...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/62_6.v"
...
coverage save results/coverage_arbiter_293.ucdb
vcover report -assert -detail -output results/assertion_report_det_293.txt results/coverage_arbiter_293.ucdb
