...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/88_2.v"
...
coverage save results/coverage_arbiter_253.ucdb
vcover report -assert -detail -output results/assertion_report_det_253.txt results/coverage_arbiter_253.ucdb
