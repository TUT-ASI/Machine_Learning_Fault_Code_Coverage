...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/50_1.v"
...
coverage save results/coverage_arbiter_426.ucdb
vcover report -assert -detail -output results/assertion_report_det_426.txt results/coverage_arbiter_426.ucdb
