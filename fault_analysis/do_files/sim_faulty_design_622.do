...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/24_0.v"
...
coverage save results/coverage_arbiter_622.ucdb
vcover report -assert -detail -output results/assertion_report_det_622.txt results/coverage_arbiter_622.ucdb
