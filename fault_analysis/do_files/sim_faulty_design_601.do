...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/130_1.v"
...
coverage save results/coverage_arbiter_601.ucdb
vcover report -assert -detail -output results/assertion_report_det_601.txt results/coverage_arbiter_601.ucdb
