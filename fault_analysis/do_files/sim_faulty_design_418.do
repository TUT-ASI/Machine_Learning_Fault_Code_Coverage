...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/76_6.v"
...
coverage save results/coverage_arbiter_418.ucdb
vcover report -assert -detail -output results/assertion_report_det_418.txt results/coverage_arbiter_418.ucdb
