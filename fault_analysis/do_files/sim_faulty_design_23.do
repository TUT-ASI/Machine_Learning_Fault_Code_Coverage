...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/91_3.v"
...
coverage save results/coverage_arbiter_23.ucdb
vcover report -assert -detail -output results/assertion_report_det_23.txt results/coverage_arbiter_23.ucdb
