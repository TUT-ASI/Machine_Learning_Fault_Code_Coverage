...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/141_0.v"
...
coverage save results/coverage_arbiter_53.ucdb
vcover report -assert -detail -output results/assertion_report_det_53.txt results/coverage_arbiter_53.ucdb
