...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/36_0.v"
...
coverage save results/coverage_arbiter_224.ucdb
vcover report -assert -detail -output results/assertion_report_det_224.txt results/coverage_arbiter_224.ucdb
