...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/97_4.v"
...
coverage save results/coverage_arbiter_21.ucdb
vcover report -assert -detail -output results/assertion_report_det_21.txt results/coverage_arbiter_21.ucdb
