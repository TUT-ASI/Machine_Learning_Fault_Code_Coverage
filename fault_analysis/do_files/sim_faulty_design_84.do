...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/7_2.v"
...
coverage save results/coverage_arbiter_84.ucdb
vcover report -assert -detail -output results/assertion_report_det_84.txt results/coverage_arbiter_84.ucdb
