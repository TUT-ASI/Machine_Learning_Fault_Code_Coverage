...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/40_4.v"
...
coverage save results/coverage_arbiter_24.ucdb
vcover report -assert -detail -output results/assertion_report_det_24.txt results/coverage_arbiter_24.ucdb
