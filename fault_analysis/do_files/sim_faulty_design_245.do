...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/9_1.v"
...
coverage save results/coverage_arbiter_245.ucdb
vcover report -assert -detail -output results/assertion_report_det_245.txt results/coverage_arbiter_245.ucdb
