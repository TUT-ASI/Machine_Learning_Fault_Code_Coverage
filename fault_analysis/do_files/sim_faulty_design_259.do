...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/81_3.v"
...
coverage save results/coverage_arbiter_259.ucdb
vcover report -assert -detail -output results/assertion_report_det_259.txt results/coverage_arbiter_259.ucdb
