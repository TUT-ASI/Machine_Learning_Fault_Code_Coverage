...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/99_1.v"
...
coverage save results/coverage_arbiter_5.ucdb
vcover report -assert -detail -output results/assertion_report_det_5.txt results/coverage_arbiter_5.ucdb
