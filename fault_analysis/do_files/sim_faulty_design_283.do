...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/31_2.v"
...
coverage save results/coverage_arbiter_283.ucdb
vcover report -assert -detail -output results/assertion_report_det_283.txt results/coverage_arbiter_283.ucdb
