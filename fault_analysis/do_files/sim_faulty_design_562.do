...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/64_4.v"
...
coverage save results/coverage_arbiter_562.ucdb
vcover report -assert -detail -output results/assertion_report_det_562.txt results/coverage_arbiter_562.ucdb
