...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/153_0.v"
...
coverage save results/coverage_arbiter_567.ucdb
vcover report -assert -detail -output results/assertion_report_det_567.txt results/coverage_arbiter_567.ucdb
