...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/26_1.v"
...
coverage save results/coverage_arbiter_57.ucdb
vcover report -assert -detail -output results/assertion_report_det_57.txt results/coverage_arbiter_57.ucdb
