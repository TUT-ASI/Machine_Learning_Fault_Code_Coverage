...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/26_0.v"
...
coverage save results/coverage_arbiter_459.ucdb
vcover report -assert -detail -output results/assertion_report_det_459.txt results/coverage_arbiter_459.ucdb
