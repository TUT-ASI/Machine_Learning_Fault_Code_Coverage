...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/71_0.v"
...
coverage save results/coverage_arbiter_195.ucdb
vcover report -assert -detail -output results/assertion_report_det_195.txt results/coverage_arbiter_195.ucdb
