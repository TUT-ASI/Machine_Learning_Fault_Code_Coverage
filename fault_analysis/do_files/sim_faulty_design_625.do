...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/52_0.v"
...
coverage save results/coverage_arbiter_625.ucdb
vcover report -assert -detail -output results/assertion_report_det_625.txt results/coverage_arbiter_625.ucdb
