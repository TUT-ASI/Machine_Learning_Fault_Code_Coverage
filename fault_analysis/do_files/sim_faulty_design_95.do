...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/24_6.v"
...
coverage save results/coverage_arbiter_95.ucdb
vcover report -assert -detail -output results/assertion_report_det_95.txt results/coverage_arbiter_95.ucdb
