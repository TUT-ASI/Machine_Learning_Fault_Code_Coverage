...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/80_1.v"
...
coverage save results/coverage_arbiter_627.ucdb
vcover report -assert -detail -output results/assertion_report_det_627.txt results/coverage_arbiter_627.ucdb
