...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/38_1.v"
...
coverage save results/coverage_arbiter_483.ucdb
vcover report -assert -detail -output results/assertion_report_det_483.txt results/coverage_arbiter_483.ucdb
