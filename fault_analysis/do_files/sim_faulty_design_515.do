...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/17_0.v"
...
coverage save results/coverage_arbiter_515.ucdb
vcover report -assert -detail -output results/assertion_report_det_515.txt results/coverage_arbiter_515.ucdb
