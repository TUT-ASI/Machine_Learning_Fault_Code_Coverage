...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/89_2.v"
...
coverage save results/coverage_arbiter_579.ucdb
vcover report -assert -detail -output results/assertion_report_det_579.txt results/coverage_arbiter_579.ucdb
