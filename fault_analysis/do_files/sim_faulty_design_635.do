...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/92_1.v"
...
coverage save results/coverage_arbiter_635.ucdb
vcover report -assert -detail -output results/assertion_report_det_635.txt results/coverage_arbiter_635.ucdb
