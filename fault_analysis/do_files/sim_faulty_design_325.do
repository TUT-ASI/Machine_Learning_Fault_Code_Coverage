...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/66_4.v"
...
coverage save results/coverage_arbiter_325.ucdb
vcover report -assert -detail -output results/assertion_report_det_325.txt results/coverage_arbiter_325.ucdb
