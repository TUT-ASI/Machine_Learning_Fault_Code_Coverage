...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/40_5.v"
...
coverage save results/coverage_arbiter_401.ucdb
vcover report -assert -detail -output results/assertion_report_det_401.txt results/coverage_arbiter_401.ucdb
