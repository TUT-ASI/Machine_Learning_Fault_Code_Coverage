...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/93_1.v"
...
coverage save results/coverage_arbiter_408.ucdb
vcover report -assert -detail -output results/assertion_report_det_408.txt results/coverage_arbiter_408.ucdb
