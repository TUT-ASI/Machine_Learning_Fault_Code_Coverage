...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/20_2.v"
...
coverage save results/coverage_arbiter_597.ucdb
vcover report -assert -detail -output results/assertion_report_det_597.txt results/coverage_arbiter_597.ucdb
