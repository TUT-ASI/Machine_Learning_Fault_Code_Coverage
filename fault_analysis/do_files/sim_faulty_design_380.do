...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/102_4.v"
...
coverage save results/coverage_arbiter_380.ucdb
vcover report -assert -detail -output results/assertion_report_det_380.txt results/coverage_arbiter_380.ucdb
