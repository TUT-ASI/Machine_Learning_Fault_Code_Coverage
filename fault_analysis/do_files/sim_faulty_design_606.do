...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/42_2.v"
...
coverage save results/coverage_arbiter_606.ucdb
vcover report -assert -detail -output results/assertion_report_det_606.txt results/coverage_arbiter_606.ucdb
