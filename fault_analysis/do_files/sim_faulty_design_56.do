...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/37_3.v"
...
coverage save results/coverage_arbiter_56.ucdb
vcover report -assert -detail -output results/assertion_report_det_56.txt results/coverage_arbiter_56.ucdb
