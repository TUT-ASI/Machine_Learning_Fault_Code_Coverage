...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/127_2.v"
...
coverage save results/coverage_arbiter_612.ucdb
vcover report -assert -detail -output results/assertion_report_det_612.txt results/coverage_arbiter_612.ucdb
