...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/95_3.v"
...
coverage save results/coverage_arbiter_360.ucdb
vcover report -assert -detail -output results/assertion_report_det_360.txt results/coverage_arbiter_360.ucdb
