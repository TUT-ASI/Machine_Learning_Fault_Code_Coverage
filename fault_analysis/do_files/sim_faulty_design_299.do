...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/73_0.v"
...
coverage save results/coverage_arbiter_299.ucdb
vcover report -assert -detail -output results/assertion_report_det_299.txt results/coverage_arbiter_299.ucdb
