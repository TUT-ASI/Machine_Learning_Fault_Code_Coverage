...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/24_3.v"
...
coverage save results/coverage_arbiter_282.ucdb
vcover report -assert -detail -output results/assertion_report_det_282.txt results/coverage_arbiter_282.ucdb
