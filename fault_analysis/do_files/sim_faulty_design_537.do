...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/16_1.v"
...
coverage save results/coverage_arbiter_537.ucdb
vcover report -assert -detail -output results/assertion_report_det_537.txt results/coverage_arbiter_537.ucdb
