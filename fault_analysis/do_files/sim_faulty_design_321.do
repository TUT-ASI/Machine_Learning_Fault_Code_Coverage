...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/62_4.v"
...
coverage save results/coverage_arbiter_321.ucdb
vcover report -assert -detail -output results/assertion_report_det_321.txt results/coverage_arbiter_321.ucdb
