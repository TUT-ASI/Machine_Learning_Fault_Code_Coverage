...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/59_1.v"
...
coverage save results/coverage_arbiter_584.ucdb
vcover report -assert -detail -output results/assertion_report_det_584.txt results/coverage_arbiter_584.ucdb
