...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/40_0.v"
...
coverage save results/coverage_arbiter_72.ucdb
vcover report -assert -detail -output results/assertion_report_det_72.txt results/coverage_arbiter_72.ucdb
