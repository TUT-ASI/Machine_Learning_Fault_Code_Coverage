...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/6_2.v"
...
coverage save results/coverage_arbiter_436.ucdb
vcover report -assert -detail -output results/assertion_report_det_436.txt results/coverage_arbiter_436.ucdb
