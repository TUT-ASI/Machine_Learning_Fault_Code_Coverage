...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/97_6.v"
...
coverage save results/coverage_arbiter_294.ucdb
vcover report -assert -detail -output results/assertion_report_det_294.txt results/coverage_arbiter_294.ucdb
