...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/39_3.v"
...
coverage save results/coverage_arbiter_117.ucdb
vcover report -assert -detail -output results/assertion_report_det_117.txt results/coverage_arbiter_117.ucdb
