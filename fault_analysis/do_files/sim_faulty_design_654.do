...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/59_4.v"
...
coverage save results/coverage_arbiter_654.ucdb
vcover report -assert -detail -output results/assertion_report_det_654.txt results/coverage_arbiter_654.ucdb
