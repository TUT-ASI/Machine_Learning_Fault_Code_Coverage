...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/66_0.v"
...
coverage save results/coverage_arbiter_471.ucdb
vcover report -assert -detail -output results/assertion_report_det_471.txt results/coverage_arbiter_471.ucdb
