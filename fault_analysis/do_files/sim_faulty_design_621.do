...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/95_4.v"
...
coverage save results/coverage_arbiter_621.ucdb
vcover report -assert -detail -output results/assertion_report_det_621.txt results/coverage_arbiter_621.ucdb
