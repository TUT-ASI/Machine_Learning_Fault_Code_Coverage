...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/22_1.v"
...
coverage save results/coverage_arbiter_77.ucdb
vcover report -assert -detail -output results/assertion_report_det_77.txt results/coverage_arbiter_77.ucdb
