...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/144_8.v"
...
coverage save results/coverage_arbiter_391.ucdb
vcover report -assert -detail -output results/assertion_report_det_391.txt results/coverage_arbiter_391.ucdb
