...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/38_0.v"
...
coverage save results/coverage_arbiter_127.ucdb
vcover report -assert -detail -output results/assertion_report_det_127.txt results/coverage_arbiter_127.ucdb
