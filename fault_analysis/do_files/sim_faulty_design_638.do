...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/81_1.v"
...
coverage save results/coverage_arbiter_638.ucdb
vcover report -assert -detail -output results/assertion_report_det_638.txt results/coverage_arbiter_638.ucdb
