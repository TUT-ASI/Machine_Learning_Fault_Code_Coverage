...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/22_4.v"
...
coverage save results/coverage_arbiter_529.ucdb
vcover report -assert -detail -output results/assertion_report_det_529.txt results/coverage_arbiter_529.ucdb
