...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/82_1.v"
...
coverage save results/coverage_arbiter_474.ucdb
vcover report -assert -detail -output results/assertion_report_det_474.txt results/coverage_arbiter_474.ucdb
