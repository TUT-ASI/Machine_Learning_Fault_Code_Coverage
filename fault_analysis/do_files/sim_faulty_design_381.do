...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/47_4.v"
...
coverage save results/coverage_arbiter_381.ucdb
vcover report -assert -detail -output results/assertion_report_det_381.txt results/coverage_arbiter_381.ucdb
