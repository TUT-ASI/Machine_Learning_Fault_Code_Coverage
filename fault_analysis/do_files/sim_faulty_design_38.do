...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/108_2.v"
...
coverage save results/coverage_arbiter_38.ucdb
vcover report -assert -detail -output results/assertion_report_det_38.txt results/coverage_arbiter_38.ucdb
