...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/86_1.v"
...
coverage save results/coverage_arbiter_268.ucdb
vcover report -assert -detail -output results/assertion_report_det_268.txt results/coverage_arbiter_268.ucdb
