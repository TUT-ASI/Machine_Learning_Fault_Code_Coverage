...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/45_0.v"
...
coverage save results/coverage_arbiter_280.ucdb
vcover report -assert -detail -output results/assertion_report_det_280.txt results/coverage_arbiter_280.ucdb
