...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/64_6.v"
...
coverage save results/coverage_arbiter_428.ucdb
vcover report -assert -detail -output results/assertion_report_det_428.txt results/coverage_arbiter_428.ucdb
