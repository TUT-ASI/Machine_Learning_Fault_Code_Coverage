...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/11_2.v"
...
coverage save results/coverage_arbiter_126.ucdb
vcover report -assert -detail -output results/assertion_report_det_126.txt results/coverage_arbiter_126.ucdb
