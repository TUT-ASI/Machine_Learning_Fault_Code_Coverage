...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/79_1.v"
...
coverage save results/coverage_arbiter_353.ucdb
vcover report -assert -detail -output results/assertion_report_det_353.txt results/coverage_arbiter_353.ucdb
