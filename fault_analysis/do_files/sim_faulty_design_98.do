...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/64_0.v"
...
coverage save results/coverage_arbiter_98.ucdb
vcover report -assert -detail -output results/assertion_report_det_98.txt results/coverage_arbiter_98.ucdb
