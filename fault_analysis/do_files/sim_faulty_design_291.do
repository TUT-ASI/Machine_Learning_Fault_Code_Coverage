...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/90_0.v"
...
coverage save results/coverage_arbiter_291.ucdb
vcover report -assert -detail -output results/assertion_report_det_291.txt results/coverage_arbiter_291.ucdb
