...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/43_0.v"
...
coverage save results/coverage_arbiter_543.ucdb
vcover report -assert -detail -output results/assertion_report_det_543.txt results/coverage_arbiter_543.ucdb
