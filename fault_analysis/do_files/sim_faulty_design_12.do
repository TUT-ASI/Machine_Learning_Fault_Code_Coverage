...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/51_2.v"
...
coverage save results/coverage_arbiter_12.ucdb
vcover report -assert -detail -output results/assertion_report_det_12.txt results/coverage_arbiter_12.ucdb
