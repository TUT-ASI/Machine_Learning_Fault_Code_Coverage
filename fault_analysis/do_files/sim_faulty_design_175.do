...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/29_0.v"
...
coverage save results/coverage_arbiter_175.ucdb
vcover report -assert -detail -output results/assertion_report_det_175.txt results/coverage_arbiter_175.ucdb
