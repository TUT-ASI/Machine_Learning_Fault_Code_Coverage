...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/98_0.v"
...
coverage save results/coverage_arbiter_519.ucdb
vcover report -assert -detail -output results/assertion_report_det_519.txt results/coverage_arbiter_519.ucdb
