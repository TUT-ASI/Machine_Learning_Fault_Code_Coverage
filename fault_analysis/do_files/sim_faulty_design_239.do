...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/65_0.v"
...
coverage save results/coverage_arbiter_239.ucdb
vcover report -assert -detail -output results/assertion_report_det_239.txt results/coverage_arbiter_239.ucdb
