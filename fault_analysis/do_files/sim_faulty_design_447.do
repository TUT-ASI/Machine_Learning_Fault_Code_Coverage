...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/82_2.v"
...
coverage save results/coverage_arbiter_447.ucdb
vcover report -assert -detail -output results/assertion_report_det_447.txt results/coverage_arbiter_447.ucdb
