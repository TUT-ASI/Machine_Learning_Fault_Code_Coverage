...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/19_1.v"
...
coverage save results/coverage_arbiter_630.ucdb
vcover report -assert -detail -output results/assertion_report_det_630.txt results/coverage_arbiter_630.ucdb
