...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/88_1.v"
...
coverage save results/coverage_arbiter_120.ucdb
vcover report -assert -detail -output results/assertion_report_det_120.txt results/coverage_arbiter_120.ucdb
