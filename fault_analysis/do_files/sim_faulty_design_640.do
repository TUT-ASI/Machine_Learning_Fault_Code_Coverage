...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/8_0.v"
...
coverage save results/coverage_arbiter_640.ucdb
vcover report -assert -detail -output results/assertion_report_det_640.txt results/coverage_arbiter_640.ucdb
