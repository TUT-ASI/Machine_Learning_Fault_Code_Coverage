...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/131_2.v"
...
coverage save results/coverage_arbiter_41.ucdb
vcover report -assert -detail -output results/assertion_report_det_41.txt results/coverage_arbiter_41.ucdb
