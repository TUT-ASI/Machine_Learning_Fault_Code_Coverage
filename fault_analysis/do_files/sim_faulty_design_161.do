...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/35_0.v"
...
coverage save results/coverage_arbiter_161.ucdb
vcover report -assert -detail -output results/assertion_report_det_161.txt results/coverage_arbiter_161.ucdb
