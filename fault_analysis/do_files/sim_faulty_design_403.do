...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/91_2.v"
...
coverage save results/coverage_arbiter_403.ucdb
vcover report -assert -detail -output results/assertion_report_det_403.txt results/coverage_arbiter_403.ucdb
