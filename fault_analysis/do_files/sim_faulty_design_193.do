...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/48_2.v"
...
coverage save results/coverage_arbiter_193.ucdb
vcover report -assert -detail -output results/assertion_report_det_193.txt results/coverage_arbiter_193.ucdb
