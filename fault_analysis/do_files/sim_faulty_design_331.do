...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/39_2.v"
...
coverage save results/coverage_arbiter_331.ucdb
vcover report -assert -detail -output results/assertion_report_det_331.txt results/coverage_arbiter_331.ucdb
