...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/78_6.v"
...
coverage save results/coverage_arbiter_485.ucdb
vcover report -assert -detail -output results/assertion_report_det_485.txt results/coverage_arbiter_485.ucdb
