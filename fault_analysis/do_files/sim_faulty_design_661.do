...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/83_0.v"
...
coverage save results/coverage_arbiter_661.ucdb
vcover report -assert -detail -output results/assertion_report_det_661.txt results/coverage_arbiter_661.ucdb
