...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/115_4.v"
...
coverage save results/coverage_arbiter_19.ucdb
vcover report -assert -detail -output results/assertion_report_det_19.txt results/coverage_arbiter_19.ucdb
