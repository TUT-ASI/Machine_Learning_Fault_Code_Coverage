...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/97_2.v"
...
coverage save results/coverage_arbiter_199.ucdb
vcover report -assert -detail -output results/assertion_report_det_199.txt results/coverage_arbiter_199.ucdb
