...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/63_1.v"
...
coverage save results/coverage_arbiter_11.ucdb
vcover report -assert -detail -output results/assertion_report_det_11.txt results/coverage_arbiter_11.ucdb
