...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/41_0.v"
...
coverage save results/coverage_arbiter_632.ucdb
vcover report -assert -detail -output results/assertion_report_det_632.txt results/coverage_arbiter_632.ucdb
