...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/6_0.v"
...
coverage save results/coverage_arbiter_388.ucdb
vcover report -assert -detail -output results/assertion_report_det_388.txt results/coverage_arbiter_388.ucdb
