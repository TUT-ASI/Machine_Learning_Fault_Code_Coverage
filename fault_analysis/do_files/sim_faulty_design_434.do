...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/102_2.v"
...
coverage save results/coverage_arbiter_434.ucdb
vcover report -assert -detail -output results/assertion_report_det_434.txt results/coverage_arbiter_434.ucdb
