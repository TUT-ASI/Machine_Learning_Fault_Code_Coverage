...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/14_0.v"
...
coverage save results/coverage_arbiter_546.ucdb
vcover report -assert -detail -output results/assertion_report_det_546.txt results/coverage_arbiter_546.ucdb
