...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/23_2.v"
...
coverage save results/coverage_arbiter_443.ucdb
vcover report -assert -detail -output results/assertion_report_det_443.txt results/coverage_arbiter_443.ucdb
