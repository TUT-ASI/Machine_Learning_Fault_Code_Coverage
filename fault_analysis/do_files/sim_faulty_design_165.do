...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/16_0.v"
...
coverage save results/coverage_arbiter_165.ucdb
vcover report -assert -detail -output results/assertion_report_det_165.txt results/coverage_arbiter_165.ucdb
