...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/26_5.v"
...
coverage save results/coverage_arbiter_324.ucdb
vcover report -assert -detail -output results/assertion_report_det_324.txt results/coverage_arbiter_324.ucdb
