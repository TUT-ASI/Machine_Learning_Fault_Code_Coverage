...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/108_1.v"
...
coverage save results/coverage_arbiter_433.ucdb
vcover report -assert -detail -output results/assertion_report_det_433.txt results/coverage_arbiter_433.ucdb
