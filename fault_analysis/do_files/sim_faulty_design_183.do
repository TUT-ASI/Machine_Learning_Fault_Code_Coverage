...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/1_0.v"
...
coverage save results/coverage_arbiter_183.ucdb
vcover report -assert -detail -output results/assertion_report_det_183.txt results/coverage_arbiter_183.ucdb
