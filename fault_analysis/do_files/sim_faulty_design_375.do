...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/56_3.v"
...
coverage save results/coverage_arbiter_375.ucdb
vcover report -assert -detail -output results/assertion_report_det_375.txt results/coverage_arbiter_375.ucdb
