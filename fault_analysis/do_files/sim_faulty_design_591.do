...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/13_1.v"
...
coverage save results/coverage_arbiter_591.ucdb
vcover report -assert -detail -output results/assertion_report_det_591.txt results/coverage_arbiter_591.ucdb
