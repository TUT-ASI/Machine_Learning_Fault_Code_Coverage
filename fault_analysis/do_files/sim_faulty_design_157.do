...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/138_1.v"
...
coverage save results/coverage_arbiter_157.ucdb
vcover report -assert -detail -output results/assertion_report_det_157.txt results/coverage_arbiter_157.ucdb
