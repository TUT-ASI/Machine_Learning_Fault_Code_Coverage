...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/24_1.v"
...
coverage save results/coverage_arbiter_243.ucdb
vcover report -assert -detail -output results/assertion_report_det_243.txt results/coverage_arbiter_243.ucdb
