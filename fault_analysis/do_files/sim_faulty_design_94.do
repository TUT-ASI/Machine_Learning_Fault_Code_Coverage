...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/102_0.v"
...
coverage save results/coverage_arbiter_94.ucdb
vcover report -assert -detail -output results/assertion_report_det_94.txt results/coverage_arbiter_94.ucdb
