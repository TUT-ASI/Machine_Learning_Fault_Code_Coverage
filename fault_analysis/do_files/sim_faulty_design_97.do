...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/39_0.v"
...
coverage save results/coverage_arbiter_97.ucdb
vcover report -assert -detail -output results/assertion_report_det_97.txt results/coverage_arbiter_97.ucdb
