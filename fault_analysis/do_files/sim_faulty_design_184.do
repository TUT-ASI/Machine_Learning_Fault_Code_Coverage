...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/45_6.v"
...
coverage save results/coverage_arbiter_184.ucdb
vcover report -assert -detail -output results/assertion_report_det_184.txt results/coverage_arbiter_184.ucdb
