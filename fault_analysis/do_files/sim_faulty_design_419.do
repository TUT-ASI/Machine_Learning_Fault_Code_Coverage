...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/78_4.v"
...
coverage save results/coverage_arbiter_419.ucdb
vcover report -assert -detail -output results/assertion_report_det_419.txt results/coverage_arbiter_419.ucdb
