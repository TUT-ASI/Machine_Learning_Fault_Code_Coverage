...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/147_1.v"
...
coverage save results/coverage_arbiter_8.ucdb
vcover report -assert -detail -output results/assertion_report_det_8.txt results/coverage_arbiter_8.ucdb
