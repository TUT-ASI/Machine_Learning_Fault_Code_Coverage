...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/116_2.v"
...
coverage save results/coverage_arbiter_87.ucdb
vcover report -assert -detail -output results/assertion_report_det_87.txt results/coverage_arbiter_87.ucdb
