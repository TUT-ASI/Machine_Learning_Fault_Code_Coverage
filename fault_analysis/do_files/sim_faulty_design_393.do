...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/107_1.v"
...
coverage save results/coverage_arbiter_393.ucdb
vcover report -assert -detail -output results/assertion_report_det_393.txt results/coverage_arbiter_393.ucdb
