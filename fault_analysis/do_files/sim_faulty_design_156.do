...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/56_0.v"
...
coverage save results/coverage_arbiter_156.ucdb
vcover report -assert -detail -output results/assertion_report_det_156.txt results/coverage_arbiter_156.ucdb
