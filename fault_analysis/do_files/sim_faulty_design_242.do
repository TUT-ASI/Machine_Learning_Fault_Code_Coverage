...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/10_1.v"
...
coverage save results/coverage_arbiter_242.ucdb
vcover report -assert -detail -output results/assertion_report_det_242.txt results/coverage_arbiter_242.ucdb
