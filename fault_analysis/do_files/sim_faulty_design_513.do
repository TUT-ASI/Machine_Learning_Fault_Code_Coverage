...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/68_2.v"
...
coverage save results/coverage_arbiter_513.ucdb
vcover report -assert -detail -output results/assertion_report_det_513.txt results/coverage_arbiter_513.ucdb
