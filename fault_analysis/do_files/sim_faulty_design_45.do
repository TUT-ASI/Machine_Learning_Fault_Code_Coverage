...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/59_2.v"
...
coverage save results/coverage_arbiter_45.ucdb
vcover report -assert -detail -output results/assertion_report_det_45.txt results/coverage_arbiter_45.ucdb
