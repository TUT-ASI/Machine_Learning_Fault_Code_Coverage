...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/105_1.v"
...
coverage save results/coverage_arbiter_89.ucdb
vcover report -assert -detail -output results/assertion_report_det_89.txt results/coverage_arbiter_89.ucdb
