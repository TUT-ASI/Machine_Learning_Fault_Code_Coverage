...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/94_2.v"
...
coverage save results/coverage_arbiter_261.ucdb
vcover report -assert -detail -output results/assertion_report_det_261.txt results/coverage_arbiter_261.ucdb
