...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/97_3.v"
...
coverage save results/coverage_arbiter_52.ucdb
vcover report -assert -detail -output results/assertion_report_det_52.txt results/coverage_arbiter_52.ucdb
