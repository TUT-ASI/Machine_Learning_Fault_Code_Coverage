...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/112_1.v"
...
coverage save results/coverage_arbiter_185.ucdb
vcover report -assert -detail -output results/assertion_report_det_185.txt results/coverage_arbiter_185.ucdb
