...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/3_1.v"
...
coverage save results/coverage_arbiter_656.ucdb
vcover report -assert -detail -output results/assertion_report_det_656.txt results/coverage_arbiter_656.ucdb
