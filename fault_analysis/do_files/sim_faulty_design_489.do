...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/38_5.v"
...
coverage save results/coverage_arbiter_489.ucdb
vcover report -assert -detail -output results/assertion_report_det_489.txt results/coverage_arbiter_489.ucdb
