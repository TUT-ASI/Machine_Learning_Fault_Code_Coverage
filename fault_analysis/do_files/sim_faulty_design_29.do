...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/46_1.v"
...
coverage save results/coverage_arbiter_29.ucdb
vcover report -assert -detail -output results/assertion_report_det_29.txt results/coverage_arbiter_29.ucdb
