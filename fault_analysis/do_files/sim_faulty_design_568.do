...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/76_2.v"
...
coverage save results/coverage_arbiter_568.ucdb
vcover report -assert -detail -output results/assertion_report_det_568.txt results/coverage_arbiter_568.ucdb
