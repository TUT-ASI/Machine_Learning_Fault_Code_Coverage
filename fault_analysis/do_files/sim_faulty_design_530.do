...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/49_5.v"
...
coverage save results/coverage_arbiter_530.ucdb
vcover report -assert -detail -output results/assertion_report_det_530.txt results/coverage_arbiter_530.ucdb
