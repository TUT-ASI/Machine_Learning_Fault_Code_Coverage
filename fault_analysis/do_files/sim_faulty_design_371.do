...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/49_0.v"
...
coverage save results/coverage_arbiter_371.ucdb
vcover report -assert -detail -output results/assertion_report_det_371.txt results/coverage_arbiter_371.ucdb
