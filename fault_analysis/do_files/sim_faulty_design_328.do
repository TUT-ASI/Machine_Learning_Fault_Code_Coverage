...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/34_0.v"
...
coverage save results/coverage_arbiter_328.ucdb
vcover report -assert -detail -output results/assertion_report_det_328.txt results/coverage_arbiter_328.ucdb
