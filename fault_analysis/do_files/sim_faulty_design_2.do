...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/151_4.v"
...
coverage save results/coverage_arbiter_2.ucdb
vcover report -assert -detail -output results/assertion_report_det_2.txt results/coverage_arbiter_2.ucdb
