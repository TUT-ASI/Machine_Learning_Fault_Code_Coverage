...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/75_3.v"
...
coverage save results/coverage_arbiter_128.ucdb
vcover report -assert -detail -output results/assertion_report_det_128.txt results/coverage_arbiter_128.ucdb
