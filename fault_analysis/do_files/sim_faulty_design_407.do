...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/75_0.v"
...
coverage save results/coverage_arbiter_407.ucdb
vcover report -assert -detail -output results/assertion_report_det_407.txt results/coverage_arbiter_407.ucdb
