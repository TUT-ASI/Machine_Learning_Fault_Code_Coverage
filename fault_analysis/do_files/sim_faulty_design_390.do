...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/59_6.v"
...
coverage save results/coverage_arbiter_390.ucdb
vcover report -assert -detail -output results/assertion_report_det_390.txt results/coverage_arbiter_390.ucdb
