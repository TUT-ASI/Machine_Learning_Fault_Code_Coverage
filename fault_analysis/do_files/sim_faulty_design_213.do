...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/39_6.v"
...
coverage save results/coverage_arbiter_213.ucdb
vcover report -assert -detail -output results/assertion_report_det_213.txt results/coverage_arbiter_213.ucdb
