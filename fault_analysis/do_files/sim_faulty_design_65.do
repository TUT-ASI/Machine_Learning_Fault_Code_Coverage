...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/96_6.v"
...
coverage save results/coverage_arbiter_65.ucdb
vcover report -assert -detail -output results/assertion_report_det_65.txt results/coverage_arbiter_65.ucdb
