...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/58_5.v"
...
coverage save results/coverage_arbiter_319.ucdb
vcover report -assert -detail -output results/assertion_report_det_319.txt results/coverage_arbiter_319.ucdb
