...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/79_0.v"
...
coverage save results/coverage_arbiter_10.ucdb
vcover report -assert -detail -output results/assertion_report_det_10.txt results/coverage_arbiter_10.ucdb
