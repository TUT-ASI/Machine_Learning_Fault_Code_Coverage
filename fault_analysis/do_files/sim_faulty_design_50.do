...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/21_1.v"
...
coverage save results/coverage_arbiter_50.ucdb
vcover report -assert -detail -output results/assertion_report_det_50.txt results/coverage_arbiter_50.ucdb
