...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/62_2.v"
...
coverage save results/coverage_arbiter_158.ucdb
vcover report -assert -detail -output results/assertion_report_det_158.txt results/coverage_arbiter_158.ucdb
