...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/43_4.v"
...
coverage save results/coverage_arbiter_217.ucdb
vcover report -assert -detail -output results/assertion_report_det_217.txt results/coverage_arbiter_217.ucdb
