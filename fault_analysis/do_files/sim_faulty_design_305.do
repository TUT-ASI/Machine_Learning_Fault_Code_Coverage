...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/53_1.v"
...
coverage save results/coverage_arbiter_305.ucdb
vcover report -assert -detail -output results/assertion_report_det_305.txt results/coverage_arbiter_305.ucdb
