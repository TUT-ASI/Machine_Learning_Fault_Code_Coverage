...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/120_1.v"
...
coverage save results/coverage_arbiter_20.ucdb
vcover report -assert -detail -output results/assertion_report_det_20.txt results/coverage_arbiter_20.ucdb
