...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/102_1.v"
...
coverage save results/coverage_arbiter_547.ucdb
vcover report -assert -detail -output results/assertion_report_det_547.txt results/coverage_arbiter_547.ucdb
