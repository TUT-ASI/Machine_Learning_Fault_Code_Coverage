...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/28_4.v"
...
coverage save results/coverage_arbiter_615.ucdb
vcover report -assert -detail -output results/assertion_report_det_615.txt results/coverage_arbiter_615.ucdb
