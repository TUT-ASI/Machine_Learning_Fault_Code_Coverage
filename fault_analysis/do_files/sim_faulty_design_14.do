...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/33_3.v"
...
coverage save results/coverage_arbiter_14.ucdb
vcover report -assert -detail -output results/assertion_report_det_14.txt results/coverage_arbiter_14.ucdb
