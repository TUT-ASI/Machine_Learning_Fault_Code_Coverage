...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/100_0.v"
...
coverage save results/coverage_arbiter_100.ucdb
vcover report -assert -detail -output results/assertion_report_det_100.txt results/coverage_arbiter_100.ucdb
