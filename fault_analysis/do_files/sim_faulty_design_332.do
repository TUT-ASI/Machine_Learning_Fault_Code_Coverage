...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/55_3.v"
...
coverage save results/coverage_arbiter_332.ucdb
vcover report -assert -detail -output results/assertion_report_det_332.txt results/coverage_arbiter_332.ucdb
