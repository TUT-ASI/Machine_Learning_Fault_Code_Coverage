...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/49_4.v"
...
coverage save results/coverage_arbiter_163.ucdb
vcover report -assert -detail -output results/assertion_report_det_163.txt results/coverage_arbiter_163.ucdb
