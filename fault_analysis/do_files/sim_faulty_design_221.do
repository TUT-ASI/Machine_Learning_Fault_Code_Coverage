...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/92_0.v"
...
coverage save results/coverage_arbiter_221.ucdb
vcover report -assert -detail -output results/assertion_report_det_221.txt results/coverage_arbiter_221.ucdb
