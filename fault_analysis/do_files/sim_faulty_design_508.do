...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/15_1.v"
...
coverage save results/coverage_arbiter_508.ucdb
vcover report -assert -detail -output results/assertion_report_det_508.txt results/coverage_arbiter_508.ucdb
