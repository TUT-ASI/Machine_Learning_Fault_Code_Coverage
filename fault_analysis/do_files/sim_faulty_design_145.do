...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/45_2.v"
...
coverage save results/coverage_arbiter_145.ucdb
vcover report -assert -detail -output results/assertion_report_det_145.txt results/coverage_arbiter_145.ucdb
