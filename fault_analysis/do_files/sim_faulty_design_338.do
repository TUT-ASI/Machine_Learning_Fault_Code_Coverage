...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/34_2.v"
...
coverage save results/coverage_arbiter_338.ucdb
vcover report -assert -detail -output results/assertion_report_det_338.txt results/coverage_arbiter_338.ucdb
