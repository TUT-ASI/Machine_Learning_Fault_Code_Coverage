...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/93_2.v"
...
coverage save results/coverage_arbiter_651.ucdb
vcover report -assert -detail -output results/assertion_report_det_651.txt results/coverage_arbiter_651.ucdb
