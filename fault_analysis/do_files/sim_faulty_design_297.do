...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/71_1.v"
...
coverage save results/coverage_arbiter_297.ucdb
vcover report -assert -detail -output results/assertion_report_det_297.txt results/coverage_arbiter_297.ucdb
