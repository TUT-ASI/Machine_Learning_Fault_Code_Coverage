...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/85_2.v"
...
coverage save results/coverage_arbiter_608.ucdb
vcover report -assert -detail -output results/assertion_report_det_608.txt results/coverage_arbiter_608.ucdb
