...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/28_3.v"
...
coverage save results/coverage_arbiter_464.ucdb
vcover report -assert -detail -output results/assertion_report_det_464.txt results/coverage_arbiter_464.ucdb
