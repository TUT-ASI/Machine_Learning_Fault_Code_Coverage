...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/45_5.v"
...
coverage save results/coverage_arbiter_633.ucdb
vcover report -assert -detail -output results/assertion_report_det_633.txt results/coverage_arbiter_633.ucdb
