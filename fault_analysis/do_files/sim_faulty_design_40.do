...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/93_0.v"
...
coverage save results/coverage_arbiter_40.ucdb
vcover report -assert -detail -output results/assertion_report_det_40.txt results/coverage_arbiter_40.ucdb
