...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/63_0.v"
...
coverage save results/coverage_arbiter_504.ucdb
vcover report -assert -detail -output results/assertion_report_det_504.txt results/coverage_arbiter_504.ucdb
