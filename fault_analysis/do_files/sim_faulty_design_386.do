...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/81_0.v"
...
coverage save results/coverage_arbiter_386.ucdb
vcover report -assert -detail -output results/assertion_report_det_386.txt results/coverage_arbiter_386.ucdb
