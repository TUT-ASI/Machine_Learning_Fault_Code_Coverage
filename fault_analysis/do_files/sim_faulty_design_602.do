...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/12_2.v"
...
coverage save results/coverage_arbiter_602.ucdb
vcover report -assert -detail -output results/assertion_report_det_602.txt results/coverage_arbiter_602.ucdb
