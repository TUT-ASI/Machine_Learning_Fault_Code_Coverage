...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/75_2.v"
...
coverage save results/coverage_arbiter_382.ucdb
vcover report -assert -detail -output results/assertion_report_det_382.txt results/coverage_arbiter_382.ucdb
