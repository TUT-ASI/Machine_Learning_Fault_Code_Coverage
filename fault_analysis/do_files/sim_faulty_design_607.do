...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/67_1.v"
...
coverage save results/coverage_arbiter_607.ucdb
vcover report -assert -detail -output results/assertion_report_det_607.txt results/coverage_arbiter_607.ucdb
