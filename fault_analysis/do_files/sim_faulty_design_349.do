...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/55_2.v"
...
coverage save results/coverage_arbiter_349.ucdb
vcover report -assert -detail -output results/assertion_report_det_349.txt results/coverage_arbiter_349.ucdb
