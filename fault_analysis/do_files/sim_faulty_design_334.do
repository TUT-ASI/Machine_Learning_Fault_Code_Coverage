...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/22_2.v"
...
coverage save results/coverage_arbiter_334.ucdb
vcover report -assert -detail -output results/assertion_report_det_334.txt results/coverage_arbiter_334.ucdb
