...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/76_1.v"
...
coverage save results/coverage_arbiter_4.ucdb
vcover report -assert -detail -output results/assertion_report_det_4.txt results/coverage_arbiter_4.ucdb
