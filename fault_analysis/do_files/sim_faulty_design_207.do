...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/53_0.v"
...
coverage save results/coverage_arbiter_207.ucdb
vcover report -assert -detail -output results/assertion_report_det_207.txt results/coverage_arbiter_207.ucdb
