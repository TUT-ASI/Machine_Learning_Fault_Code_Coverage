...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/120_2.v"
...
coverage save results/coverage_arbiter_177.ucdb
vcover report -assert -detail -output results/assertion_report_det_177.txt results/coverage_arbiter_177.ucdb
