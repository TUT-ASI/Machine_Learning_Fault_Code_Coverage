...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/100_4.v"
...
coverage save results/coverage_arbiter_404.ucdb
vcover report -assert -detail -output results/assertion_report_det_404.txt results/coverage_arbiter_404.ucdb
