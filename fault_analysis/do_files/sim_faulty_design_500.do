...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/94_1.v"
...
coverage save results/coverage_arbiter_500.ucdb
vcover report -assert -detail -output results/assertion_report_det_500.txt results/coverage_arbiter_500.ucdb
