...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/138_0.v"
...
coverage save results/coverage_arbiter_455.ucdb
vcover report -assert -detail -output results/assertion_report_det_455.txt results/coverage_arbiter_455.ucdb
