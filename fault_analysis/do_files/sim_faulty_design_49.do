...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/41_1.v"
...
coverage save results/coverage_arbiter_49.ucdb
vcover report -assert -detail -output results/assertion_report_det_49.txt results/coverage_arbiter_49.ucdb
