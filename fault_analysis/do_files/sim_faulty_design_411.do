...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/86_2.v"
...
coverage save results/coverage_arbiter_411.ucdb
vcover report -assert -detail -output results/assertion_report_det_411.txt results/coverage_arbiter_411.ucdb
