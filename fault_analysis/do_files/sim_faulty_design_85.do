...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/82_0.v"
...
coverage save results/coverage_arbiter_85.ucdb
vcover report -assert -detail -output results/assertion_report_det_85.txt results/coverage_arbiter_85.ucdb
