...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/87_1.v"
...
coverage save results/coverage_arbiter_484.ucdb
vcover report -assert -detail -output results/assertion_report_det_484.txt results/coverage_arbiter_484.ucdb
