...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/33_0.v"
...
coverage save results/coverage_arbiter_27.ucdb
vcover report -assert -detail -output results/assertion_report_det_27.txt results/coverage_arbiter_27.ucdb
