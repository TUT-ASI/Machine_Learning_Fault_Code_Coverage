...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/130_2.v"
...
coverage save results/coverage_arbiter_74.ucdb
vcover report -assert -detail -output results/assertion_report_det_74.txt results/coverage_arbiter_74.ucdb
