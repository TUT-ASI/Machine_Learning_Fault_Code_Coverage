...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/96_5.v"
...
coverage save results/coverage_arbiter_30.ucdb
vcover report -assert -detail -output results/assertion_report_det_30.txt results/coverage_arbiter_30.ucdb
