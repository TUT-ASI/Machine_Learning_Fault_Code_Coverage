...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/57_5.v"
...
coverage save results/coverage_arbiter_366.ucdb
vcover report -assert -detail -output results/assertion_report_det_366.txt results/coverage_arbiter_366.ucdb
