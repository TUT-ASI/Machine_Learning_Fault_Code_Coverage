...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/54_1.v"
...
coverage save results/coverage_arbiter_626.ucdb
vcover report -assert -detail -output results/assertion_report_det_626.txt results/coverage_arbiter_626.ucdb
