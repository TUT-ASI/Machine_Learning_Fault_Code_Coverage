...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/101_0.v"
...
coverage save results/coverage_arbiter_286.ucdb
vcover report -assert -detail -output results/assertion_report_det_286.txt results/coverage_arbiter_286.ucdb
