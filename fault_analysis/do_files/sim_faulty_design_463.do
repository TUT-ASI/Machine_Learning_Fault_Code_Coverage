...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/129_3.v"
...
coverage save results/coverage_arbiter_463.ucdb
vcover report -assert -detail -output results/assertion_report_det_463.txt results/coverage_arbiter_463.ucdb
