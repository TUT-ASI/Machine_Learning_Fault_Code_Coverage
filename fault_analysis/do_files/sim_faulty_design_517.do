...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/66_1.v"
...
coverage save results/coverage_arbiter_517.ucdb
vcover report -assert -detail -output results/assertion_report_det_517.txt results/coverage_arbiter_517.ucdb
