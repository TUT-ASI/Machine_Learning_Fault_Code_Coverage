...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/72_1.v"
...
coverage save results/coverage_arbiter_272.ucdb
vcover report -assert -detail -output results/assertion_report_det_272.txt results/coverage_arbiter_272.ucdb
