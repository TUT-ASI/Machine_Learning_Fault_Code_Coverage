...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/52_1.v"
...
coverage save results/coverage_arbiter_257.ucdb
vcover report -assert -detail -output results/assertion_report_det_257.txt results/coverage_arbiter_257.ucdb
