...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/25_0.v"
...
coverage save results/coverage_arbiter_70.ucdb
vcover report -assert -detail -output results/assertion_report_det_70.txt results/coverage_arbiter_70.ucdb
