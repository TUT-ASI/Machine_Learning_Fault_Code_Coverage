...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/37_1.v"
...
coverage save results/coverage_arbiter_308.ucdb
vcover report -assert -detail -output results/assertion_report_det_308.txt results/coverage_arbiter_308.ucdb
