...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/94_0.v"
...
coverage save results/coverage_arbiter_480.ucdb
vcover report -assert -detail -output results/assertion_report_det_480.txt results/coverage_arbiter_480.ucdb
