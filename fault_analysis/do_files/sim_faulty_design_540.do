...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/32_0.v"
...
coverage save results/coverage_arbiter_540.ucdb
vcover report -assert -detail -output results/assertion_report_det_540.txt results/coverage_arbiter_540.ucdb
