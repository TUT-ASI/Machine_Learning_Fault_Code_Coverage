...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/13_0.v"
...
coverage save results/coverage_arbiter_497.ucdb
vcover report -assert -detail -output results/assertion_report_det_497.txt results/coverage_arbiter_497.ucdb
