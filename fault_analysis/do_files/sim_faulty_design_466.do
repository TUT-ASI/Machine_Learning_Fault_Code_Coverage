...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/69_1.v"
...
coverage save results/coverage_arbiter_466.ucdb
vcover report -assert -detail -output results/assertion_report_det_466.txt results/coverage_arbiter_466.ucdb
