...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/12_0.v"
...
coverage save results/coverage_arbiter_492.ucdb
vcover report -assert -detail -output results/assertion_report_det_492.txt results/coverage_arbiter_492.ucdb
