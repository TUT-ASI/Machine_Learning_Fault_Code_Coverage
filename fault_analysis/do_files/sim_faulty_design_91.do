...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/4_3.v"
...
coverage save results/coverage_arbiter_91.ucdb
vcover report -assert -detail -output results/assertion_report_det_91.txt results/coverage_arbiter_91.ucdb
