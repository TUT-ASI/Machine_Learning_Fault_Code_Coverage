...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/104_1.v"
...
coverage save results/coverage_arbiter_160.ucdb
vcover report -assert -detail -output results/assertion_report_det_160.txt results/coverage_arbiter_160.ucdb
