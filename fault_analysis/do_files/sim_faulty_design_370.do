...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/19_2.v"
...
coverage save results/coverage_arbiter_370.ucdb
vcover report -assert -detail -output results/assertion_report_det_370.txt results/coverage_arbiter_370.ucdb
