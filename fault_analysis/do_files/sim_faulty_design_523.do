...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/60_0.v"
...
coverage save results/coverage_arbiter_523.ucdb
vcover report -assert -detail -output results/assertion_report_det_523.txt results/coverage_arbiter_523.ucdb
