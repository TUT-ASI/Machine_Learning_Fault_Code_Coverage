...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/67_0.v"
...
coverage save results/coverage_arbiter_637.ucdb
vcover report -assert -detail -output results/assertion_report_det_637.txt results/coverage_arbiter_637.ucdb
