...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/43_2.v"
...
coverage save results/coverage_arbiter_167.ucdb
vcover report -assert -detail -output results/assertion_report_det_167.txt results/coverage_arbiter_167.ucdb
