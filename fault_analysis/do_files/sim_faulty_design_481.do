...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/66_6.v"
...
coverage save results/coverage_arbiter_481.ucdb
vcover report -assert -detail -output results/assertion_report_det_481.txt results/coverage_arbiter_481.ucdb
