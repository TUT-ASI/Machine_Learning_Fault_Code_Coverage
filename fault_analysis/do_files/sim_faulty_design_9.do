...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/42_0.v"
...
coverage save results/coverage_arbiter_9.ucdb
vcover report -assert -detail -output results/assertion_report_det_9.txt results/coverage_arbiter_9.ucdb
