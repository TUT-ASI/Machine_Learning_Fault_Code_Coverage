...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/74_2.v"
...
coverage save results/coverage_arbiter_542.ucdb
vcover report -assert -detail -output results/assertion_report_det_542.txt results/coverage_arbiter_542.ucdb
