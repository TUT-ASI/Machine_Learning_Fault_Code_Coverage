...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/125_6.v"
...
coverage save results/coverage_arbiter_68.ucdb
vcover report -assert -detail -output results/assertion_report_det_68.txt results/coverage_arbiter_68.ucdb
