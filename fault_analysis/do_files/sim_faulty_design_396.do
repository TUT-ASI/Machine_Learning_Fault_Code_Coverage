...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/89_1.v"
...
coverage save results/coverage_arbiter_396.ucdb
vcover report -assert -detail -output results/assertion_report_det_396.txt results/coverage_arbiter_396.ucdb
