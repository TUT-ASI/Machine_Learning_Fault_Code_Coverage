...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/68_6.v"
...
coverage save results/coverage_arbiter_532.ucdb
vcover report -assert -detail -output results/assertion_report_det_532.txt results/coverage_arbiter_532.ucdb
