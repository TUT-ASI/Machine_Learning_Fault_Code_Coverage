...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/28_6.v"
...
coverage save results/coverage_arbiter_550.ucdb
vcover report -assert -detail -output results/assertion_report_det_550.txt results/coverage_arbiter_550.ucdb
