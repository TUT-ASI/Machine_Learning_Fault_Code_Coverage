...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/67_2.v"
...
coverage save results/coverage_arbiter_571.ucdb
vcover report -assert -detail -output results/assertion_report_det_571.txt results/coverage_arbiter_571.ucdb
