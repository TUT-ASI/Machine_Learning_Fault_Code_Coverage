...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/85_1.v"
...
coverage save results/coverage_arbiter_563.ucdb
vcover report -assert -detail -output results/assertion_report_det_563.txt results/coverage_arbiter_563.ucdb
