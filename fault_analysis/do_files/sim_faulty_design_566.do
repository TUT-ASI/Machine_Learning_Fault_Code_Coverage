...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/47_3.v"
...
coverage save results/coverage_arbiter_566.ucdb
vcover report -assert -detail -output results/assertion_report_det_566.txt results/coverage_arbiter_566.ucdb
