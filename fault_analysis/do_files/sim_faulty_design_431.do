...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/83_3.v"
...
coverage save results/coverage_arbiter_431.ucdb
vcover report -assert -detail -output results/assertion_report_det_431.txt results/coverage_arbiter_431.ucdb
