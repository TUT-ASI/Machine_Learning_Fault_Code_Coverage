...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/57_6.v"
...
coverage save results/coverage_arbiter_495.ucdb
vcover report -assert -detail -output results/assertion_report_det_495.txt results/coverage_arbiter_495.ucdb
