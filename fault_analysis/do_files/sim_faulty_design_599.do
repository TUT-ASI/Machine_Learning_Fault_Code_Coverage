...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/83_1.v"
...
coverage save results/coverage_arbiter_599.ucdb
vcover report -assert -detail -output results/assertion_report_det_599.txt results/coverage_arbiter_599.ucdb
