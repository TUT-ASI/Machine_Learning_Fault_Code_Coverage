...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/92_2.v"
...
coverage save results/coverage_arbiter_617.ucdb
vcover report -assert -detail -output results/assertion_report_det_617.txt results/coverage_arbiter_617.ucdb
