...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/99_2.v"
...
coverage save results/coverage_arbiter_525.ucdb
vcover report -assert -detail -output results/assertion_report_det_525.txt results/coverage_arbiter_525.ucdb
