...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/30_3.v"
...
coverage save results/coverage_arbiter_592.ucdb
vcover report -assert -detail -output results/assertion_report_det_592.txt results/coverage_arbiter_592.ucdb
