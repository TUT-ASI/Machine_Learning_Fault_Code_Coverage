...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/27_2.v"
...
coverage save results/coverage_arbiter_440.ucdb
vcover report -assert -detail -output results/assertion_report_det_440.txt results/coverage_arbiter_440.ucdb
