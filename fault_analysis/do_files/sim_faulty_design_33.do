...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/116_0.v"
...
coverage save results/coverage_arbiter_33.ucdb
vcover report -assert -detail -output results/assertion_report_det_33.txt results/coverage_arbiter_33.ucdb
