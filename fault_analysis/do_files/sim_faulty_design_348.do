...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/32_2.v"
...
coverage save results/coverage_arbiter_348.ucdb
vcover report -assert -detail -output results/assertion_report_det_348.txt results/coverage_arbiter_348.ucdb
