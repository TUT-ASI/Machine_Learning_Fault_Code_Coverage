...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/90_3.v"
...
coverage save results/coverage_arbiter_215.ucdb
vcover report -assert -detail -output results/assertion_report_det_215.txt results/coverage_arbiter_215.ucdb
