...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/18_0.v"
...
coverage save results/coverage_arbiter_578.ucdb
vcover report -assert -detail -output results/assertion_report_det_578.txt results/coverage_arbiter_578.ucdb
