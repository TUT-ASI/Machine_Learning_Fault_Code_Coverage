...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/9_0.v"
...
coverage save results/coverage_arbiter_394.ucdb
vcover report -assert -detail -output results/assertion_report_det_394.txt results/coverage_arbiter_394.ucdb
