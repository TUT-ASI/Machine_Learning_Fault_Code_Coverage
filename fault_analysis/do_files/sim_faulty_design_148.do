...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/59_3.v"
...
coverage save results/coverage_arbiter_148.ucdb
vcover report -assert -detail -output results/assertion_report_det_148.txt results/coverage_arbiter_148.ucdb
