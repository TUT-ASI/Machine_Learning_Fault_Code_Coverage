...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/31_0.v"
...
coverage save results/coverage_arbiter_441.ucdb
vcover report -assert -detail -output results/assertion_report_det_441.txt results/coverage_arbiter_441.ucdb
