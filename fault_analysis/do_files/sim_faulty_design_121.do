...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/60_1.v"
...
coverage save results/coverage_arbiter_121.ucdb
vcover report -assert -detail -output results/assertion_report_det_121.txt results/coverage_arbiter_121.ucdb
