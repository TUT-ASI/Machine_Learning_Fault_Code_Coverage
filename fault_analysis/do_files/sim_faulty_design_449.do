...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/38_3.v"
...
coverage save results/coverage_arbiter_449.ucdb
vcover report -assert -detail -output results/assertion_report_det_449.txt results/coverage_arbiter_449.ucdb
