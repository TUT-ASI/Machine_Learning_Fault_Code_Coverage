...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/4_0.v"
...
coverage save results/coverage_arbiter_575.ucdb
vcover report -assert -detail -output results/assertion_report_det_575.txt results/coverage_arbiter_575.ucdb
