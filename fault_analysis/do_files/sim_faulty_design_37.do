...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/104_3.v"
...
coverage save results/coverage_arbiter_37.ucdb
vcover report -assert -detail -output results/assertion_report_det_37.txt results/coverage_arbiter_37.ucdb
