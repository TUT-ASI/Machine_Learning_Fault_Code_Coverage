...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/68_5.v"
...
coverage save results/coverage_arbiter_453.ucdb
vcover report -assert -detail -output results/assertion_report_det_453.txt results/coverage_arbiter_453.ucdb
