...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/14_2.v"
...
coverage save results/coverage_arbiter_392.ucdb
vcover report -assert -detail -output results/assertion_report_det_392.txt results/coverage_arbiter_392.ucdb
