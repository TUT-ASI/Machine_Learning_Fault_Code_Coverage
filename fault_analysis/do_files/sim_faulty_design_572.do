...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/121_3.v"
...
coverage save results/coverage_arbiter_572.ucdb
vcover report -assert -detail -output results/assertion_report_det_572.txt results/coverage_arbiter_572.ucdb
