...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/40_1.v"
...
coverage save results/coverage_arbiter_549.ucdb
vcover report -assert -detail -output results/assertion_report_det_549.txt results/coverage_arbiter_549.ucdb
