...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/1_2.v"
...
coverage save results/coverage_arbiter_588.ucdb
vcover report -assert -detail -output results/assertion_report_det_588.txt results/coverage_arbiter_588.ucdb
