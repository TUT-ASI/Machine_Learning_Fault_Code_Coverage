...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/87_6.v"
...
coverage save results/coverage_arbiter_424.ucdb
vcover report -assert -detail -output results/assertion_report_det_424.txt results/coverage_arbiter_424.ucdb
