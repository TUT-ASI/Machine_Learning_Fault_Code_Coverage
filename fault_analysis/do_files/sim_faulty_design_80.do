...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/83_6.v"
...
coverage save results/coverage_arbiter_80.ucdb
vcover report -assert -detail -output results/assertion_report_det_80.txt results/coverage_arbiter_80.ucdb
