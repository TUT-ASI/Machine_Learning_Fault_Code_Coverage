...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/123_3.v"
...
coverage save results/coverage_arbiter_96.ucdb
vcover report -assert -detail -output results/assertion_report_det_96.txt results/coverage_arbiter_96.ucdb
