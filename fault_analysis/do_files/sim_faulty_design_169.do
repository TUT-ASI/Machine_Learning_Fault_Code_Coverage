...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/49_6.v"
...
coverage save results/coverage_arbiter_169.ucdb
vcover report -assert -detail -output results/assertion_report_det_169.txt results/coverage_arbiter_169.ucdb
