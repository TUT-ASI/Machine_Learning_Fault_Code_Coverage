...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/17_2.v"
...
coverage save results/coverage_arbiter_54.ucdb
vcover report -assert -detail -output results/assertion_report_det_54.txt results/coverage_arbiter_54.ucdb
