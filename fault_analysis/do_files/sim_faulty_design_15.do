...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/151_3.v"
...
coverage save results/coverage_arbiter_15.ucdb
vcover report -assert -detail -output results/assertion_report_det_15.txt results/coverage_arbiter_15.ucdb
