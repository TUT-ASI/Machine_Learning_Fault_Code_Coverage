...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/62_0.v"
...
coverage save results/coverage_arbiter_639.ucdb
vcover report -assert -detail -output results/assertion_report_det_639.txt results/coverage_arbiter_639.ucdb
