...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/76_5.v"
...
coverage save results/coverage_arbiter_556.ucdb
vcover report -assert -detail -output results/assertion_report_det_556.txt results/coverage_arbiter_556.ucdb
