...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/89_0.v"
...
coverage save results/coverage_arbiter_252.ucdb
vcover report -assert -detail -output results/assertion_report_det_252.txt results/coverage_arbiter_252.ucdb
