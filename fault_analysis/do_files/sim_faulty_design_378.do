...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/56_1.v"
...
coverage save results/coverage_arbiter_378.ucdb
vcover report -assert -detail -output results/assertion_report_det_378.txt results/coverage_arbiter_378.ucdb
