...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/3_0.v"
...
coverage save results/coverage_arbiter_287.ucdb
vcover report -assert -detail -output results/assertion_report_det_287.txt results/coverage_arbiter_287.ucdb
