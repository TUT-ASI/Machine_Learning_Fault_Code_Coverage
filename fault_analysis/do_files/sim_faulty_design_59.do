...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/59_0.v"
...
coverage save results/coverage_arbiter_59.ucdb
vcover report -assert -detail -output results/assertion_report_det_59.txt results/coverage_arbiter_59.ucdb
