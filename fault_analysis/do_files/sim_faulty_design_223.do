...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/37_0.v"
...
coverage save results/coverage_arbiter_223.ucdb
vcover report -assert -detail -output results/assertion_report_det_223.txt results/coverage_arbiter_223.ucdb
