...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/78_1.v"
...
coverage save results/coverage_arbiter_1.ucdb
vcover report -assert -detail -output results/assertion_report_det_1.txt results/coverage_arbiter_1.ucdb
