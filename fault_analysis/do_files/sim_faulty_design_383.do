...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/40_3.v"
...
coverage save results/coverage_arbiter_383.ucdb
vcover report -assert -detail -output results/assertion_report_det_383.txt results/coverage_arbiter_383.ucdb
