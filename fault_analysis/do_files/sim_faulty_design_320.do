...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/77_1.v"
...
coverage save results/coverage_arbiter_320.ucdb
vcover report -assert -detail -output results/assertion_report_det_320.txt results/coverage_arbiter_320.ucdb
