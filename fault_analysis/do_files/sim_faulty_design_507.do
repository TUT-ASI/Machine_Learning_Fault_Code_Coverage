...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/27_0.v"
...
coverage save results/coverage_arbiter_507.ucdb
vcover report -assert -detail -output results/assertion_report_det_507.txt results/coverage_arbiter_507.ucdb
