...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/10_0.v"
...
coverage save results/coverage_arbiter_364.ucdb
vcover report -assert -detail -output results/assertion_report_det_364.txt results/coverage_arbiter_364.ucdb
