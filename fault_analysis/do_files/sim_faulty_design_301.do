...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/39_4.v"
...
coverage save results/coverage_arbiter_301.ucdb
vcover report -assert -detail -output results/assertion_report_det_301.txt results/coverage_arbiter_301.ucdb
