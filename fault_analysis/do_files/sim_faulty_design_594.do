...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/87_5.v"
...
coverage save results/coverage_arbiter_594.ucdb
vcover report -assert -detail -output results/assertion_report_det_594.txt results/coverage_arbiter_594.ucdb
