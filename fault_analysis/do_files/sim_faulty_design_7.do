...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/112_3.v"
...
coverage save results/coverage_arbiter_7.ucdb
vcover report -assert -detail -output results/assertion_report_det_7.txt results/coverage_arbiter_7.ucdb
