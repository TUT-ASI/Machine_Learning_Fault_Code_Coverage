...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/35_3.v"
...
coverage save results/coverage_arbiter_564.ucdb
vcover report -assert -detail -output results/assertion_report_det_564.txt results/coverage_arbiter_564.ucdb
