...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/7_0.v"
...
coverage save results/coverage_arbiter_619.ucdb
vcover report -assert -detail -output results/assertion_report_det_619.txt results/coverage_arbiter_619.ucdb
