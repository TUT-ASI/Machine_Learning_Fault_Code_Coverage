...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/3_2.v"
...
coverage save results/coverage_arbiter_341.ucdb
vcover report -assert -detail -output results/assertion_report_det_341.txt results/coverage_arbiter_341.ucdb
