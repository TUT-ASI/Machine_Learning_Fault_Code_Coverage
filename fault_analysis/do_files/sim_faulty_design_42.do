...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/91_1.v"
...
coverage save results/coverage_arbiter_42.ucdb
vcover report -assert -detail -output results/assertion_report_det_42.txt results/coverage_arbiter_42.ucdb
