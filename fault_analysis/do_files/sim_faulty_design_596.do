...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/55_1.v"
...
coverage save results/coverage_arbiter_596.ucdb
vcover report -assert -detail -output results/assertion_report_det_596.txt results/coverage_arbiter_596.ucdb
