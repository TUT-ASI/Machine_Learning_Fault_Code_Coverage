...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/74_3.v"
...
coverage save results/coverage_arbiter_457.ucdb
vcover report -assert -detail -output results/assertion_report_det_457.txt results/coverage_arbiter_457.ucdb
