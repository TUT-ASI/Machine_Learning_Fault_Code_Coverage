...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/22_0.v"
...
coverage save results/coverage_arbiter_76.ucdb
vcover report -assert -detail -output results/assertion_report_det_76.txt results/coverage_arbiter_76.ucdb
