...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/52_3.v"
...
coverage save results/coverage_arbiter_264.ucdb
vcover report -assert -detail -output results/assertion_report_det_264.txt results/coverage_arbiter_264.ucdb
