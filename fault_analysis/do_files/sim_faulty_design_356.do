...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/77_5.v"
...
coverage save results/coverage_arbiter_356.ucdb
vcover report -assert -detail -output results/assertion_report_det_356.txt results/coverage_arbiter_356.ucdb
