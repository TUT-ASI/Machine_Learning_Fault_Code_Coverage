...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/137_0.v"
...
coverage save results/coverage_arbiter_581.ucdb
vcover report -assert -detail -output results/assertion_report_det_581.txt results/coverage_arbiter_581.ucdb
