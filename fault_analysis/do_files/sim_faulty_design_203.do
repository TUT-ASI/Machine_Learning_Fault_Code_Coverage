...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/50_0.v"
...
coverage save results/coverage_arbiter_203.ucdb
vcover report -assert -detail -output results/assertion_report_det_203.txt results/coverage_arbiter_203.ucdb
