...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/72_0.v"
...
coverage save results/coverage_arbiter_139.ucdb
vcover report -assert -detail -output results/assertion_report_det_139.txt results/coverage_arbiter_139.ucdb
