...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/52_2.v"
...
coverage save results/coverage_arbiter_284.ucdb
vcover report -assert -detail -output results/assertion_report_det_284.txt results/coverage_arbiter_284.ucdb
