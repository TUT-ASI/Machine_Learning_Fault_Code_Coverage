...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/72_3.v"
...
coverage save results/coverage_arbiter_219.ucdb
vcover report -assert -detail -output results/assertion_report_det_219.txt results/coverage_arbiter_219.ucdb
