...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/151_5.v"
...
coverage save results/coverage_arbiter_647.ucdb
vcover report -assert -detail -output results/assertion_report_det_647.txt results/coverage_arbiter_647.ucdb
