...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/33_1.v"
...
coverage save results/coverage_arbiter_524.ucdb
vcover report -assert -detail -output results/assertion_report_det_524.txt results/coverage_arbiter_524.ucdb
