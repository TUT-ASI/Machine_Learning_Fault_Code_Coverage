...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/90_1.v"
...
coverage save results/coverage_arbiter_509.ucdb
vcover report -assert -detail -output results/assertion_report_det_509.txt results/coverage_arbiter_509.ucdb
