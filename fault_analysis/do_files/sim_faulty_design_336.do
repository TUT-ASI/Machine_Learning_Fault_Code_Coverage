...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/61_1.v"
...
coverage save results/coverage_arbiter_336.ucdb
vcover report -assert -detail -output results/assertion_report_det_336.txt results/coverage_arbiter_336.ucdb
