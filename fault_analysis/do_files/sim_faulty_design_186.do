...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/92_3.v"
...
coverage save results/coverage_arbiter_186.ucdb
vcover report -assert -detail -output results/assertion_report_det_186.txt results/coverage_arbiter_186.ucdb
