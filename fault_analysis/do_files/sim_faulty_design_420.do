...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/11_1.v"
...
coverage save results/coverage_arbiter_420.ucdb
vcover report -assert -detail -output results/assertion_report_det_420.txt results/coverage_arbiter_420.ucdb
