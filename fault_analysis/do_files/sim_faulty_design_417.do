...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/66_5.v"
...
coverage save results/coverage_arbiter_417.ucdb
vcover report -assert -detail -output results/assertion_report_det_417.txt results/coverage_arbiter_417.ucdb
