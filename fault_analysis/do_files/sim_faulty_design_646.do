...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/54_0.v"
...
coverage save results/coverage_arbiter_646.ucdb
vcover report -assert -detail -output results/assertion_report_det_646.txt results/coverage_arbiter_646.ucdb
