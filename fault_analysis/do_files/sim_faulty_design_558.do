...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/36_1.v"
...
coverage save results/coverage_arbiter_558.ucdb
vcover report -assert -detail -output results/assertion_report_det_558.txt results/coverage_arbiter_558.ucdb
