...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/18_1.v"
...
coverage save results/coverage_arbiter_143.ucdb
vcover report -assert -detail -output results/assertion_report_det_143.txt results/coverage_arbiter_143.ucdb
