...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/30_2.v"
...
coverage save results/coverage_arbiter_620.ucdb
vcover report -assert -detail -output results/assertion_report_det_620.txt results/coverage_arbiter_620.ucdb
