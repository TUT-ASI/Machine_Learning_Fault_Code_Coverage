...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/48_1.v"
...
coverage save results/coverage_arbiter_560.ucdb
vcover report -assert -detail -output results/assertion_report_det_560.txt results/coverage_arbiter_560.ucdb
