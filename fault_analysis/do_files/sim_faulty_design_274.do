...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/76_3.v"
...
coverage save results/coverage_arbiter_274.ucdb
vcover report -assert -detail -output results/assertion_report_det_274.txt results/coverage_arbiter_274.ucdb
