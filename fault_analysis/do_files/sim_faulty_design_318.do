...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/47_6.v"
...
coverage save results/coverage_arbiter_318.ucdb
vcover report -assert -detail -output results/assertion_report_det_318.txt results/coverage_arbiter_318.ucdb
