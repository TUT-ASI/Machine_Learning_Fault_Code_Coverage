...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/105_0.v"
...
coverage save results/coverage_arbiter_289.ucdb
vcover report -assert -detail -output results/assertion_report_det_289.txt results/coverage_arbiter_289.ucdb
