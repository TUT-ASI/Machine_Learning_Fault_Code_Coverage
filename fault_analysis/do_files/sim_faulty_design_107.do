...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/99_0.v"
...
coverage save results/coverage_arbiter_107.ucdb
vcover report -assert -detail -output results/assertion_report_det_107.txt results/coverage_arbiter_107.ucdb
