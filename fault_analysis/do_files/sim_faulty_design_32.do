...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/31_1.v"
...
coverage save results/coverage_arbiter_32.ucdb
vcover report -assert -detail -output results/assertion_report_det_32.txt results/coverage_arbiter_32.ucdb
