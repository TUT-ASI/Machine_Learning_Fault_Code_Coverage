...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/45_1.v"
...
coverage save results/coverage_arbiter_665.ucdb
vcover report -assert -detail -output results/assertion_report_det_665.txt results/coverage_arbiter_665.ucdb
