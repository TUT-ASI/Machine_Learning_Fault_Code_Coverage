...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/78_5.v"
...
coverage save results/coverage_arbiter_425.ucdb
vcover report -assert -detail -output results/assertion_report_det_425.txt results/coverage_arbiter_425.ucdb
