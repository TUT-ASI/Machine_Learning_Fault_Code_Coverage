...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/126_2.v"
...
coverage save results/coverage_arbiter_6.ucdb
vcover report -assert -detail -output results/assertion_report_det_6.txt results/coverage_arbiter_6.ucdb
