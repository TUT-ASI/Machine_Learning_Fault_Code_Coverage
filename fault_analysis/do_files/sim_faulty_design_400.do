...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/58_0.v"
...
coverage save results/coverage_arbiter_400.ucdb
vcover report -assert -detail -output results/assertion_report_det_400.txt results/coverage_arbiter_400.ucdb
