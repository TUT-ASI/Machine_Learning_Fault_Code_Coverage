...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/87_0.v"
...
coverage save results/coverage_arbiter_534.ucdb
vcover report -assert -detail -output results/assertion_report_det_534.txt results/coverage_arbiter_534.ucdb
