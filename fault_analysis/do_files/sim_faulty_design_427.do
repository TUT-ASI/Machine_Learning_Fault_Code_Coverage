...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/49_3.v"
...
coverage save results/coverage_arbiter_427.ucdb
vcover report -assert -detail -output results/assertion_report_det_427.txt results/coverage_arbiter_427.ucdb
