...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/12_1.v"
...
coverage save results/coverage_arbiter_376.ucdb
vcover report -assert -detail -output results/assertion_report_det_376.txt results/coverage_arbiter_376.ucdb
