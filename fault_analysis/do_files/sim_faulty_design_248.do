...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/78_2.v"
...
coverage save results/coverage_arbiter_248.ucdb
vcover report -assert -detail -output results/assertion_report_det_248.txt results/coverage_arbiter_248.ucdb
