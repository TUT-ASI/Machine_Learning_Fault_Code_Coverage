...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/22_6.v"
...
coverage save results/coverage_arbiter_146.ucdb
vcover report -assert -detail -output results/assertion_report_det_146.txt results/coverage_arbiter_146.ucdb
