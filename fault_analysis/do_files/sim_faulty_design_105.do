...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/95_6.v"
...
coverage save results/coverage_arbiter_105.ucdb
vcover report -assert -detail -output results/assertion_report_det_105.txt results/coverage_arbiter_105.ucdb
