...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/16_2.v"
...
coverage save results/coverage_arbiter_168.ucdb
vcover report -assert -detail -output results/assertion_report_det_168.txt results/coverage_arbiter_168.ucdb
