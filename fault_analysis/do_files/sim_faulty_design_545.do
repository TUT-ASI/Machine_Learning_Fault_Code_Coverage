...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/29_1.v"
...
coverage save results/coverage_arbiter_545.ucdb
vcover report -assert -detail -output results/assertion_report_det_545.txt results/coverage_arbiter_545.ucdb
