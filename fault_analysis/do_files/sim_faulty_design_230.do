...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/95_1.v"
...
coverage save results/coverage_arbiter_230.ucdb
vcover report -assert -detail -output results/assertion_report_det_230.txt results/coverage_arbiter_230.ucdb
