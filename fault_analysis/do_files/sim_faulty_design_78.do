...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/116_1.v"
...
coverage save results/coverage_arbiter_78.ucdb
vcover report -assert -detail -output results/assertion_report_det_78.txt results/coverage_arbiter_78.ucdb
