...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/54_3.v"
...
coverage save results/coverage_arbiter_119.ucdb
vcover report -assert -detail -output results/assertion_report_det_119.txt results/coverage_arbiter_119.ucdb
