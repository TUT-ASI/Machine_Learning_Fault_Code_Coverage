...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/36_2.v"
...
coverage save results/coverage_arbiter_212.ucdb
vcover report -assert -detail -output results/assertion_report_det_212.txt results/coverage_arbiter_212.ucdb
