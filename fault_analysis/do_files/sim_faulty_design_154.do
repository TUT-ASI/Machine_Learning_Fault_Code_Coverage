...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/15_0.v"
...
coverage save results/coverage_arbiter_154.ucdb
vcover report -assert -detail -output results/assertion_report_det_154.txt results/coverage_arbiter_154.ucdb
