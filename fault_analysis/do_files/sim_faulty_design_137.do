...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/100_2.v"
...
coverage save results/coverage_arbiter_137.ucdb
vcover report -assert -detail -output results/assertion_report_det_137.txt results/coverage_arbiter_137.ucdb
