...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/85_4.v"
...
coverage save results/coverage_arbiter_46.ucdb
vcover report -assert -detail -output results/assertion_report_det_46.txt results/coverage_arbiter_46.ucdb
