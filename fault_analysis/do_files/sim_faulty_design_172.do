...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/128_1.v"
...
coverage save results/coverage_arbiter_172.ucdb
vcover report -assert -detail -output results/assertion_report_det_172.txt results/coverage_arbiter_172.ucdb
