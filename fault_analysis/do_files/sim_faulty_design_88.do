...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/73_3.v"
...
coverage save results/coverage_arbiter_88.ucdb
vcover report -assert -detail -output results/assertion_report_det_88.txt results/coverage_arbiter_88.ucdb
