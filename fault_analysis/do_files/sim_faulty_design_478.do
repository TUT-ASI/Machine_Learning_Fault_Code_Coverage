...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/65_2.v"
...
coverage save results/coverage_arbiter_478.ucdb
vcover report -assert -detail -output results/assertion_report_det_478.txt results/coverage_arbiter_478.ucdb
