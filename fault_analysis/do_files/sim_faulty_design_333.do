...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/14_1.v"
...
coverage save results/coverage_arbiter_333.ucdb
vcover report -assert -detail -output results/assertion_report_det_333.txt results/coverage_arbiter_333.ucdb
