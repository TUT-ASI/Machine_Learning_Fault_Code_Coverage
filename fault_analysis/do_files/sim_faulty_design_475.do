...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/56_2.v"
...
coverage save results/coverage_arbiter_475.ucdb
vcover report -assert -detail -output results/assertion_report_det_475.txt results/coverage_arbiter_475.ucdb
