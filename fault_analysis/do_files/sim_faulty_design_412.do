...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/74_0.v"
...
coverage save results/coverage_arbiter_412.ucdb
vcover report -assert -detail -output results/assertion_report_det_412.txt results/coverage_arbiter_412.ucdb
