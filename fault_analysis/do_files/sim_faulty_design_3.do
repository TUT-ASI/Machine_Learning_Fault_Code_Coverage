...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/84_2.v"
...
coverage save results/coverage_arbiter_3.ucdb
vcover report -assert -detail -output results/assertion_report_det_3.txt results/coverage_arbiter_3.ucdb
