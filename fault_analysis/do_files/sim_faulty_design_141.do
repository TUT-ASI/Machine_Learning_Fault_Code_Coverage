...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/58_1.v"
...
coverage save results/coverage_arbiter_141.ucdb
vcover report -assert -detail -output results/assertion_report_det_141.txt results/coverage_arbiter_141.ucdb
