...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/135_0.v"
...
coverage save results/coverage_arbiter_83.ucdb
vcover report -assert -detail -output results/assertion_report_det_83.txt results/coverage_arbiter_83.ucdb
