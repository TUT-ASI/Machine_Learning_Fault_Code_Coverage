...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/47_2.v"
...
coverage save results/coverage_arbiter_188.ucdb
vcover report -assert -detail -output results/assertion_report_det_188.txt results/coverage_arbiter_188.ucdb
