...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/143_1.v"
...
coverage save results/coverage_arbiter_67.ucdb
vcover report -assert -detail -output results/assertion_report_det_67.txt results/coverage_arbiter_67.ucdb
