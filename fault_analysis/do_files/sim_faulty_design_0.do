...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/119_4.v"
...
coverage save results/coverage_arbiter_0.ucdb
vcover report -assert -detail -output results/assertion_report_det_0.txt results/coverage_arbiter_0.ucdb
