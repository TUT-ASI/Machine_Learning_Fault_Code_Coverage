...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/96_4.v"
...
coverage save results/coverage_arbiter_36.ucdb
vcover report -assert -detail -output results/assertion_report_det_36.txt results/coverage_arbiter_36.ucdb
