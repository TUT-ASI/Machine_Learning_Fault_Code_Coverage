...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/97_0.v"
...
coverage save results/coverage_arbiter_598.ucdb
vcover report -assert -detail -output results/assertion_report_det_598.txt results/coverage_arbiter_598.ucdb
