...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/96_1.v"
...
coverage save results/coverage_arbiter_501.ucdb
vcover report -assert -detail -output results/assertion_report_det_501.txt results/coverage_arbiter_501.ucdb
