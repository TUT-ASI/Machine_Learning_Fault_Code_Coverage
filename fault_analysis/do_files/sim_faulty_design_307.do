...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/28_2.v"
...
coverage save results/coverage_arbiter_307.ucdb
vcover report -assert -detail -output results/assertion_report_det_307.txt results/coverage_arbiter_307.ucdb
