...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/146_0.v"
...
coverage save results/coverage_arbiter_71.ucdb
vcover report -assert -detail -output results/assertion_report_det_71.txt results/coverage_arbiter_71.ucdb
