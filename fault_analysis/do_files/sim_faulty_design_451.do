...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/62_1.v"
...
coverage save results/coverage_arbiter_451.ucdb
vcover report -assert -detail -output results/assertion_report_det_451.txt results/coverage_arbiter_451.ucdb
