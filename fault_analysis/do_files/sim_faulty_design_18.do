...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/62_3.v"
...
coverage save results/coverage_arbiter_18.ucdb
vcover report -assert -detail -output results/assertion_report_det_18.txt results/coverage_arbiter_18.ucdb
