...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/2_0.v"
...
coverage save results/coverage_arbiter_491.ucdb
vcover report -assert -detail -output results/assertion_report_det_491.txt results/coverage_arbiter_491.ucdb
