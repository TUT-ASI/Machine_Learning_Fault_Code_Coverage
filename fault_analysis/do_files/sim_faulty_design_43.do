...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/48_0.v"
...
coverage save results/coverage_arbiter_43.ucdb
vcover report -assert -detail -output results/assertion_report_det_43.txt results/coverage_arbiter_43.ucdb
