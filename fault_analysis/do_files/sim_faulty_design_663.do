...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/81_4.v"
...
coverage save results/coverage_arbiter_663.ucdb
vcover report -assert -detail -output results/assertion_report_det_663.txt results/coverage_arbiter_663.ucdb
