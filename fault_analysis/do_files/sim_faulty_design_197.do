...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/96_3.v"
...
coverage save results/coverage_arbiter_197.ucdb
vcover report -assert -detail -output results/assertion_report_det_197.txt results/coverage_arbiter_197.ucdb
