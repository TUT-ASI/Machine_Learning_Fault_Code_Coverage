...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/154_0.v"
...
coverage save results/coverage_arbiter_263.ucdb
vcover report -assert -detail -output results/assertion_report_det_263.txt results/coverage_arbiter_263.ucdb
