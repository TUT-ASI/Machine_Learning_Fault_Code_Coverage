...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/133_1.v"
...
coverage save results/coverage_arbiter_93.ucdb
vcover report -assert -detail -output results/assertion_report_det_93.txt results/coverage_arbiter_93.ucdb
