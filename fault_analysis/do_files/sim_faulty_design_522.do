...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/68_4.v"
...
coverage save results/coverage_arbiter_522.ucdb
vcover report -assert -detail -output results/assertion_report_det_522.txt results/coverage_arbiter_522.ucdb
