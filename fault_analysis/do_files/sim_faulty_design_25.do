...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/86_0.v"
...
coverage save results/coverage_arbiter_25.ucdb
vcover report -assert -detail -output results/assertion_report_det_25.txt results/coverage_arbiter_25.ucdb
