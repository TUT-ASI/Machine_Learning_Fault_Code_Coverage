...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/8_2.v"
...
coverage save results/coverage_arbiter_64.ucdb
vcover report -assert -detail -output results/assertion_report_det_64.txt results/coverage_arbiter_64.ucdb
