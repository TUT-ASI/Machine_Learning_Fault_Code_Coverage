...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/77_2.v"
...
coverage save results/coverage_arbiter_554.ucdb
vcover report -assert -detail -output results/assertion_report_det_554.txt results/coverage_arbiter_554.ucdb
