...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/85_3.v"
...
coverage save results/coverage_arbiter_47.ucdb
vcover report -assert -detail -output results/assertion_report_det_47.txt results/coverage_arbiter_47.ucdb
