...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/87_3.v"
...
coverage save results/coverage_arbiter_39.ucdb
vcover report -assert -detail -output results/assertion_report_det_39.txt results/coverage_arbiter_39.ucdb
