...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/81_5.v"
...
coverage save results/coverage_arbiter_448.ucdb
vcover report -assert -detail -output results/assertion_report_det_448.txt results/coverage_arbiter_448.ucdb
