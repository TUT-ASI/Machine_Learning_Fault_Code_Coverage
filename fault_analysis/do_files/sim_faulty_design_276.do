...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/4_2.v"
...
coverage save results/coverage_arbiter_276.ucdb
vcover report -assert -detail -output results/assertion_report_det_276.txt results/coverage_arbiter_276.ucdb
