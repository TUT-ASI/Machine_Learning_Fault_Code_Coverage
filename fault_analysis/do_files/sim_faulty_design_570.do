...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/19_0.v"
...
coverage save results/coverage_arbiter_570.ucdb
vcover report -assert -detail -output results/assertion_report_det_570.txt results/coverage_arbiter_570.ucdb
