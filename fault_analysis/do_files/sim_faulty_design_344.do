...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/123_0.v"
...
coverage save results/coverage_arbiter_344.ucdb
vcover report -assert -detail -output results/assertion_report_det_344.txt results/coverage_arbiter_344.ucdb
