...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/40_2.v"
...
coverage save results/coverage_arbiter_113.ucdb
vcover report -assert -detail -output results/assertion_report_det_113.txt results/coverage_arbiter_113.ucdb
