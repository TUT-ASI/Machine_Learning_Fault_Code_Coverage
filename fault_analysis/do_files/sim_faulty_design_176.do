...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/65_1.v"
...
coverage save results/coverage_arbiter_176.ucdb
vcover report -assert -detail -output results/assertion_report_det_176.txt results/coverage_arbiter_176.ucdb
