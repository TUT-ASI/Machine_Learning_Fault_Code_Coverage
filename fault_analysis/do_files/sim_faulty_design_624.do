...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/5_0.v"
...
coverage save results/coverage_arbiter_624.ucdb
vcover report -assert -detail -output results/assertion_report_det_624.txt results/coverage_arbiter_624.ucdb
