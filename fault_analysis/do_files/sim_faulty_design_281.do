...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/32_1.v"
...
coverage save results/coverage_arbiter_281.ucdb
vcover report -assert -detail -output results/assertion_report_det_281.txt results/coverage_arbiter_281.ucdb
