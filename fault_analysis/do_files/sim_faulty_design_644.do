...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/22_5.v"
...
coverage save results/coverage_arbiter_644.ucdb
vcover report -assert -detail -output results/assertion_report_det_644.txt results/coverage_arbiter_644.ucdb
