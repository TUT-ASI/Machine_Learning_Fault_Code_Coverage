...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/24_4.v"
...
coverage save results/coverage_arbiter_106.ucdb
vcover report -assert -detail -output results/assertion_report_det_106.txt results/coverage_arbiter_106.ucdb
