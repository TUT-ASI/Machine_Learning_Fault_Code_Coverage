...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/95_2.v"
...
coverage save results/coverage_arbiter_255.ucdb
vcover report -assert -detail -output results/assertion_report_det_255.txt results/coverage_arbiter_255.ucdb
