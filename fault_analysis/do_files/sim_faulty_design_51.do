...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/130_0.v"
...
coverage save results/coverage_arbiter_51.ucdb
vcover report -assert -detail -output results/assertion_report_det_51.txt results/coverage_arbiter_51.ucdb
