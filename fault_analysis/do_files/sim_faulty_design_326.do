...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/77_0.v"
...
coverage save results/coverage_arbiter_326.ucdb
vcover report -assert -detail -output results/assertion_report_det_326.txt results/coverage_arbiter_326.ucdb
