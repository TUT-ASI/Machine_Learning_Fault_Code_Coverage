...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/26_6.v"
...
coverage save results/coverage_arbiter_439.ucdb
vcover report -assert -detail -output results/assertion_report_det_439.txt results/coverage_arbiter_439.ucdb
