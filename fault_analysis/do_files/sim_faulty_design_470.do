...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/75_1.v"
...
coverage save results/coverage_arbiter_470.ucdb
vcover report -assert -detail -output results/assertion_report_det_470.txt results/coverage_arbiter_470.ucdb
