...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/107_0.v"
...
coverage save results/coverage_arbiter_521.ucdb
vcover report -assert -detail -output results/assertion_report_det_521.txt results/coverage_arbiter_521.ucdb
