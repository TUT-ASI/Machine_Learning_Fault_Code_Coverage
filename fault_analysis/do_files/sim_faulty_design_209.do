...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/4_1.v"
...
coverage save results/coverage_arbiter_209.ucdb
vcover report -assert -detail -output results/assertion_report_det_209.txt results/coverage_arbiter_209.ucdb
