...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/95_0.v"
...
coverage save results/coverage_arbiter_285.ucdb
vcover report -assert -detail -output results/assertion_report_det_285.txt results/coverage_arbiter_285.ucdb
