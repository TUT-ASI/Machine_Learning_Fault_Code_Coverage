...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/23_1.v"
...
coverage save results/coverage_arbiter_22.ucdb
vcover report -assert -detail -output results/assertion_report_det_22.txt results/coverage_arbiter_22.ucdb
