...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/123_1.v"
...
coverage save results/coverage_arbiter_494.ucdb
vcover report -assert -detail -output results/assertion_report_det_494.txt results/coverage_arbiter_494.ucdb
