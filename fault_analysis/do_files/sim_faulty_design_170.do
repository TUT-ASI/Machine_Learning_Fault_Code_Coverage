...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/44_1.v"
...
coverage save results/coverage_arbiter_170.ucdb
vcover report -assert -detail -output results/assertion_report_det_170.txt results/coverage_arbiter_170.ucdb
