...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/28_5.v"
...
coverage save results/coverage_arbiter_655.ucdb
vcover report -assert -detail -output results/assertion_report_det_655.txt results/coverage_arbiter_655.ucdb
