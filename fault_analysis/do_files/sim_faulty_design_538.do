...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/30_5.v"
...
coverage save results/coverage_arbiter_538.ucdb
vcover report -assert -detail -output results/assertion_report_det_538.txt results/coverage_arbiter_538.ucdb
