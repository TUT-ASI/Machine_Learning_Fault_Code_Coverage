...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/46_0.v"
...
coverage save results/coverage_arbiter_86.ucdb
vcover report -assert -detail -output results/assertion_report_det_86.txt results/coverage_arbiter_86.ucdb
