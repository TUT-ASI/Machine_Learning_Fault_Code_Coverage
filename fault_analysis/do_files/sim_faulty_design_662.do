...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/70_0.v"
...
coverage save results/coverage_arbiter_662.ucdb
vcover report -assert -detail -output results/assertion_report_det_662.txt results/coverage_arbiter_662.ucdb
