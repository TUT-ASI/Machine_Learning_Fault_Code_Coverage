...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/50_2.v"
...
coverage save results/coverage_arbiter_129.ucdb
vcover report -assert -detail -output results/assertion_report_det_129.txt results/coverage_arbiter_129.ucdb
