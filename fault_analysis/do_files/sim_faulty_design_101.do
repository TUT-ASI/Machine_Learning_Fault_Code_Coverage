...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/66_2.v"
...
coverage save results/coverage_arbiter_101.ucdb
vcover report -assert -detail -output results/assertion_report_det_101.txt results/coverage_arbiter_101.ucdb
