...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/87_2.v"
...
coverage save results/coverage_arbiter_505.ucdb
vcover report -assert -detail -output results/assertion_report_det_505.txt results/coverage_arbiter_505.ucdb
