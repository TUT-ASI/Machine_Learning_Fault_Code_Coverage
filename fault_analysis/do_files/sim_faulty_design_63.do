...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/122_1.v"
...
coverage save results/coverage_arbiter_63.ucdb
vcover report -assert -detail -output results/assertion_report_det_63.txt results/coverage_arbiter_63.ucdb
