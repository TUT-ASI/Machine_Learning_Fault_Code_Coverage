...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/154_1.v"
...
coverage save results/coverage_arbiter_226.ucdb
vcover report -assert -detail -output results/assertion_report_det_226.txt results/coverage_arbiter_226.ucdb
