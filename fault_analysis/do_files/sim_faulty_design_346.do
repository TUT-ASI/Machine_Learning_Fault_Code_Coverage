...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/77_6.v"
...
coverage save results/coverage_arbiter_346.ucdb
vcover report -assert -detail -output results/assertion_report_det_346.txt results/coverage_arbiter_346.ucdb
