...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/2_1.v"
...
coverage save results/coverage_arbiter_634.ucdb
vcover report -assert -detail -output results/assertion_report_det_634.txt results/coverage_arbiter_634.ucdb
