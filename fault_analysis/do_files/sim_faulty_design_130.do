...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/77_3.v"
...
coverage save results/coverage_arbiter_130.ucdb
vcover report -assert -detail -output results/assertion_report_det_130.txt results/coverage_arbiter_130.ucdb
