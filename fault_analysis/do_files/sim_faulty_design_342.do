...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/72_2.v"
...
coverage save results/coverage_arbiter_342.ucdb
vcover report -assert -detail -output results/assertion_report_det_342.txt results/coverage_arbiter_342.ucdb
