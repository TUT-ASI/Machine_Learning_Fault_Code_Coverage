...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/47_1.v"
...
coverage save results/coverage_arbiter_473.ucdb
vcover report -assert -detail -output results/assertion_report_det_473.txt results/coverage_arbiter_473.ucdb
