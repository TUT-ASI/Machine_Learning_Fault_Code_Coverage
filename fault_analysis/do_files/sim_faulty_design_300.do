...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/35_1.v"
...
coverage save results/coverage_arbiter_300.ucdb
vcover report -assert -detail -output results/assertion_report_det_300.txt results/coverage_arbiter_300.ucdb
