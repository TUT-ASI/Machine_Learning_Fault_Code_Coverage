...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/87_4.v"
...
coverage save results/coverage_arbiter_511.ucdb
vcover report -assert -detail -output results/assertion_report_det_511.txt results/coverage_arbiter_511.ucdb
