...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/127_1.v"
...
coverage save results/coverage_arbiter_279.ucdb
vcover report -assert -detail -output results/assertion_report_det_279.txt results/coverage_arbiter_279.ucdb
