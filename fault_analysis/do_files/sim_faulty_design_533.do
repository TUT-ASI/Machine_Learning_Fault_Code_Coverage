...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/80_0.v"
...
coverage save results/coverage_arbiter_533.ucdb
vcover report -assert -detail -output results/assertion_report_det_533.txt results/coverage_arbiter_533.ucdb
