...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/20_0.v"
...
coverage save results/coverage_arbiter_582.ucdb
vcover report -assert -detail -output results/assertion_report_det_582.txt results/coverage_arbiter_582.ucdb
