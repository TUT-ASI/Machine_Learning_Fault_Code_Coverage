...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/80_2.v"
...
coverage save results/coverage_arbiter_526.ucdb
vcover report -assert -detail -output results/assertion_report_det_526.txt results/coverage_arbiter_526.ucdb
