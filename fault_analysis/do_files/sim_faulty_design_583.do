...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/39_1.v"
...
coverage save results/coverage_arbiter_583.ucdb
vcover report -assert -detail -output results/assertion_report_det_583.txt results/coverage_arbiter_583.ucdb
