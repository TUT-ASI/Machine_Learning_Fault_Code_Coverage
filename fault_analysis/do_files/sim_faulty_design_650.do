...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/41_2.v"
...
coverage save results/coverage_arbiter_650.ucdb
vcover report -assert -detail -output results/assertion_report_det_650.txt results/coverage_arbiter_650.ucdb
