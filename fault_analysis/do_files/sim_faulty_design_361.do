...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/68_0.v"
...
coverage save results/coverage_arbiter_361.ucdb
vcover report -assert -detail -output results/assertion_report_det_361.txt results/coverage_arbiter_361.ucdb
