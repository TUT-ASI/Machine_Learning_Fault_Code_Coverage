...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/61_2.v"
...
coverage save results/coverage_arbiter_614.ucdb
vcover report -assert -detail -output results/assertion_report_det_614.txt results/coverage_arbiter_614.ucdb
