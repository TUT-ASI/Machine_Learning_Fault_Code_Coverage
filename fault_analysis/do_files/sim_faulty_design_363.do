...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/37_2.v"
...
coverage save results/coverage_arbiter_363.ucdb
vcover report -assert -detail -output results/assertion_report_det_363.txt results/coverage_arbiter_363.ucdb
