...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/84_1.v"
...
coverage save results/coverage_arbiter_535.ucdb
vcover report -assert -detail -output results/assertion_report_det_535.txt results/coverage_arbiter_535.ucdb
