...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/93_3.v"
...
coverage save results/coverage_arbiter_266.ucdb
vcover report -assert -detail -output results/assertion_report_det_266.txt results/coverage_arbiter_266.ucdb
