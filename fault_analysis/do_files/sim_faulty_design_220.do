...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/8_1.v"
...
coverage save results/coverage_arbiter_220.ucdb
vcover report -assert -detail -output results/assertion_report_det_220.txt results/coverage_arbiter_220.ucdb
