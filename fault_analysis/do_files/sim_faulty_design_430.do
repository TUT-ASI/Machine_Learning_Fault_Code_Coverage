...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/44_0.v"
...
coverage save results/coverage_arbiter_430.ucdb
vcover report -assert -detail -output results/assertion_report_det_430.txt results/coverage_arbiter_430.ucdb
