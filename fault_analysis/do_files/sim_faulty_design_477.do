...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/36_3.v"
...
coverage save results/coverage_arbiter_477.ucdb
vcover report -assert -detail -output results/assertion_report_det_477.txt results/coverage_arbiter_477.ucdb
