...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/114_5.v"
...
coverage save results/coverage_arbiter_81.ucdb
vcover report -assert -detail -output results/assertion_report_det_81.txt results/coverage_arbiter_81.ucdb
