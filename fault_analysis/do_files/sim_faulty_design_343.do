...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/68_1.v"
...
coverage save results/coverage_arbiter_343.ucdb
vcover report -assert -detail -output results/assertion_report_det_343.txt results/coverage_arbiter_343.ucdb
