...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/59_5.v"
...
coverage save results/coverage_arbiter_298.ucdb
vcover report -assert -detail -output results/assertion_report_det_298.txt results/coverage_arbiter_298.ucdb
