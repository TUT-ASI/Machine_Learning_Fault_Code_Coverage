...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/28_0.v"
...
coverage save results/coverage_arbiter_600.ucdb
vcover report -assert -detail -output results/assertion_report_det_600.txt results/coverage_arbiter_600.ucdb
