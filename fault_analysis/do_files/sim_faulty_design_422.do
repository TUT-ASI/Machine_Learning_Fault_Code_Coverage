...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/95_5.v"
...
coverage save results/coverage_arbiter_422.ucdb
vcover report -assert -detail -output results/assertion_report_det_422.txt results/coverage_arbiter_422.ucdb
