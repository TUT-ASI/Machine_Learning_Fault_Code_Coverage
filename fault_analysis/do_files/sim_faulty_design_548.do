...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/51_1.v"
...
coverage save results/coverage_arbiter_548.ucdb
vcover report -assert -detail -output results/assertion_report_det_548.txt results/coverage_arbiter_548.ucdb
