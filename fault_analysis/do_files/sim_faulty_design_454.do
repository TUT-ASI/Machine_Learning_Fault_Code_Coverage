...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/70_1.v"
...
coverage save results/coverage_arbiter_454.ucdb
vcover report -assert -detail -output results/assertion_report_det_454.txt results/coverage_arbiter_454.ucdb
