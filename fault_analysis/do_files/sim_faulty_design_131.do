...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/71_2.v"
...
coverage save results/coverage_arbiter_131.ucdb
vcover report -assert -detail -output results/assertion_report_det_131.txt results/coverage_arbiter_131.ucdb
