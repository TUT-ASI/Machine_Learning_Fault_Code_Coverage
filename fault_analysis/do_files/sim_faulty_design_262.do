...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/13_2.v"
...
coverage save results/coverage_arbiter_262.ucdb
vcover report -assert -detail -output results/assertion_report_det_262.txt results/coverage_arbiter_262.ucdb
