...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/15_2.v"
...
coverage save results/coverage_arbiter_355.ucdb
vcover report -assert -detail -output results/assertion_report_det_355.txt results/coverage_arbiter_355.ucdb
