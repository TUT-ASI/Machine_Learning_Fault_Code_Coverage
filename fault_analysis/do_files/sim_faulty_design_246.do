...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/18_2.v"
...
coverage save results/coverage_arbiter_246.ucdb
vcover report -assert -detail -output results/assertion_report_det_246.txt results/coverage_arbiter_246.ucdb
