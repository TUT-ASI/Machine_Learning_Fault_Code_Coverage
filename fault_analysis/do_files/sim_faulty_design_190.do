...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/62_5.v"
...
coverage save results/coverage_arbiter_190.ucdb
vcover report -assert -detail -output results/assertion_report_det_190.txt results/coverage_arbiter_190.ucdb
