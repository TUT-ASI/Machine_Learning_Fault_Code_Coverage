...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/44_2.v"
...
coverage save results/coverage_arbiter_254.ucdb
vcover report -assert -detail -output results/assertion_report_det_254.txt results/coverage_arbiter_254.ucdb
