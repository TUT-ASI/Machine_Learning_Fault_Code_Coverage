...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/47_0.v"
...
coverage save results/coverage_arbiter_666.ucdb
vcover report -assert -detail -output results/assertion_report_det_666.txt results/coverage_arbiter_666.ucdb
