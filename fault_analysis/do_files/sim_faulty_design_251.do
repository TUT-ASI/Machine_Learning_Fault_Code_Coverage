...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/43_3.v"
...
coverage save results/coverage_arbiter_251.ucdb
vcover report -assert -detail -output results/assertion_report_det_251.txt results/coverage_arbiter_251.ucdb
