...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/79_2.v"
...
coverage save results/coverage_arbiter_26.ucdb
vcover report -assert -detail -output results/assertion_report_det_26.txt results/coverage_arbiter_26.ucdb
