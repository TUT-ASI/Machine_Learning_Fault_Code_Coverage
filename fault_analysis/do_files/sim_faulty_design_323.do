...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/28_1.v"
...
coverage save results/coverage_arbiter_323.ucdb
vcover report -assert -detail -output results/assertion_report_det_323.txt results/coverage_arbiter_323.ucdb
