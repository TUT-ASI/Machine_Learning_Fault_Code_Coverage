...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/132_0.v"
...
coverage save results/coverage_arbiter_69.ucdb
vcover report -assert -detail -output results/assertion_report_det_69.txt results/coverage_arbiter_69.ucdb
