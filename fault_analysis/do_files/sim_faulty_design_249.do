...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/73_1.v"
...
coverage save results/coverage_arbiter_249.ucdb
vcover report -assert -detail -output results/assertion_report_det_249.txt results/coverage_arbiter_249.ucdb
