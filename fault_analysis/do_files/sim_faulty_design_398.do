...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/6_1.v"
...
coverage save results/coverage_arbiter_398.ucdb
vcover report -assert -detail -output results/assertion_report_det_398.txt results/coverage_arbiter_398.ucdb
