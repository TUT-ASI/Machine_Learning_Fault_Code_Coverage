...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/27_1.v"
...
coverage save results/coverage_arbiter_589.ucdb
vcover report -assert -detail -output results/assertion_report_det_589.txt results/coverage_arbiter_589.ucdb
