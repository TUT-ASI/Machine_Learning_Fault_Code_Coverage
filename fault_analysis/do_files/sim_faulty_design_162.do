...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/55_0.v"
...
coverage save results/coverage_arbiter_162.ucdb
vcover report -assert -detail -output results/assertion_report_det_162.txt results/coverage_arbiter_162.ucdb
