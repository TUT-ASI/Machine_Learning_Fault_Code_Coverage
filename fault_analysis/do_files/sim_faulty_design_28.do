...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/69_0.v"
...
coverage save results/coverage_arbiter_28.ucdb
vcover report -assert -detail -output results/assertion_report_det_28.txt results/coverage_arbiter_28.ucdb
