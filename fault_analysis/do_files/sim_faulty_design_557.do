...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/38_6.v"
...
coverage save results/coverage_arbiter_557.ucdb
vcover report -assert -detail -output results/assertion_report_det_557.txt results/coverage_arbiter_557.ucdb
