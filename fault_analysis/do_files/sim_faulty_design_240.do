...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/11_0.v"
...
coverage save results/coverage_arbiter_240.ucdb
vcover report -assert -detail -output results/assertion_report_det_240.txt results/coverage_arbiter_240.ucdb
