...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/77_4.v"
...
coverage save results/coverage_arbiter_198.ucdb
vcover report -assert -detail -output results/assertion_report_det_198.txt results/coverage_arbiter_198.ucdb
