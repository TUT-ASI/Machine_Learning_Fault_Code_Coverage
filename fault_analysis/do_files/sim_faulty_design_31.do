...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/133_0.v"
...
coverage save results/coverage_arbiter_31.ucdb
vcover report -assert -detail -output results/assertion_report_det_31.txt results/coverage_arbiter_31.ucdb
