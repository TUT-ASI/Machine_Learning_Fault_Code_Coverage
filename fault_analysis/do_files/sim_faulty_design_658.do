...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/81_6.v"
...
coverage save results/coverage_arbiter_658.ucdb
vcover report -assert -detail -output results/assertion_report_det_658.txt results/coverage_arbiter_658.ucdb
