...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/30_6.v"
...
coverage save results/coverage_arbiter_270.ucdb
vcover report -assert -detail -output results/assertion_report_det_270.txt results/coverage_arbiter_270.ucdb
