...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/1_1.v"
...
coverage save results/coverage_arbiter_35.ucdb
vcover report -assert -detail -output results/assertion_report_det_35.txt results/coverage_arbiter_35.ucdb
