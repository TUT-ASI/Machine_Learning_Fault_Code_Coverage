...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/68_3.v"
...
coverage save results/coverage_arbiter_290.ucdb
vcover report -assert -detail -output results/assertion_report_det_290.txt results/coverage_arbiter_290.ucdb
