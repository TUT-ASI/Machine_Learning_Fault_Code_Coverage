...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/71_3.v"
...
coverage save results/coverage_arbiter_267.ucdb
vcover report -assert -detail -output results/assertion_report_det_267.txt results/coverage_arbiter_267.ucdb
