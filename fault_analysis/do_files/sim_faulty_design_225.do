...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/111_1.v"
...
coverage save results/coverage_arbiter_225.ucdb
vcover report -assert -detail -output results/assertion_report_det_225.txt results/coverage_arbiter_225.ucdb
