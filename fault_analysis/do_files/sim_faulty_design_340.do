...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/30_4.v"
...
coverage save results/coverage_arbiter_340.ucdb
vcover report -assert -detail -output results/assertion_report_det_340.txt results/coverage_arbiter_340.ucdb
