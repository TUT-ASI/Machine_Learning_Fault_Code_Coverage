...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/69_2.v"
...
coverage save results/coverage_arbiter_605.ucdb
vcover report -assert -detail -output results/assertion_report_det_605.txt results/coverage_arbiter_605.ucdb
