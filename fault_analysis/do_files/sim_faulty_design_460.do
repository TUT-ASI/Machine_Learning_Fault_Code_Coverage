...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/30_0.v"
...
coverage save results/coverage_arbiter_460.ucdb
vcover report -assert -detail -output results/assertion_report_det_460.txt results/coverage_arbiter_460.ucdb
