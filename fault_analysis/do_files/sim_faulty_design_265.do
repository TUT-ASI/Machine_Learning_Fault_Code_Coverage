...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/53_3.v"
...
coverage save results/coverage_arbiter_265.ucdb
vcover report -assert -detail -output results/assertion_report_det_265.txt results/coverage_arbiter_265.ucdb
