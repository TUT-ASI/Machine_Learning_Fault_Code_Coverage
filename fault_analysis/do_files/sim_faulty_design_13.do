...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/29_2.v"
...
coverage save results/coverage_arbiter_13.ucdb
vcover report -assert -detail -output results/assertion_report_det_13.txt results/coverage_arbiter_13.ucdb
