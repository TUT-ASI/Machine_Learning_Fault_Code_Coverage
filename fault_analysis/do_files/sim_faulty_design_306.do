...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/57_1.v"
...
coverage save results/coverage_arbiter_306.ucdb
vcover report -assert -detail -output results/assertion_report_det_306.txt results/coverage_arbiter_306.ucdb
