...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/46_2.v"
...
coverage save results/coverage_arbiter_73.ucdb
vcover report -assert -detail -output results/assertion_report_det_73.txt results/coverage_arbiter_73.ucdb
