...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/21_2.v"
...
coverage save results/coverage_arbiter_60.ucdb
vcover report -assert -detail -output results/assertion_report_det_60.txt results/coverage_arbiter_60.ucdb
