...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/24_2.v"
...
coverage save results/coverage_arbiter_206.ucdb
vcover report -assert -detail -output results/assertion_report_det_206.txt results/coverage_arbiter_206.ucdb
