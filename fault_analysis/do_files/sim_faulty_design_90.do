...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/26_3.v"
...
coverage save results/coverage_arbiter_90.ucdb
vcover report -assert -detail -output results/assertion_report_det_90.txt results/coverage_arbiter_90.ucdb
