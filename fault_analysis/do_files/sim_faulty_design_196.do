...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/98_1.v"
...
coverage save results/coverage_arbiter_196.ucdb
vcover report -assert -detail -output results/assertion_report_det_196.txt results/coverage_arbiter_196.ucdb
