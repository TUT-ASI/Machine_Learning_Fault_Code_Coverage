...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/91_0.v"
...
coverage save results/coverage_arbiter_202.ucdb
vcover report -assert -detail -output results/assertion_report_det_202.txt results/coverage_arbiter_202.ucdb
