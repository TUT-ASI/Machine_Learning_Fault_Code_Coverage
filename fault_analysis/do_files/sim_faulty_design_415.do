...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/47_5.v"
...
coverage save results/coverage_arbiter_415.ucdb
vcover report -assert -detail -output results/assertion_report_det_415.txt results/coverage_arbiter_415.ucdb
