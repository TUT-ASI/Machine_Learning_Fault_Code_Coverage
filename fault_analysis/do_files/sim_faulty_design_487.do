...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/114_1.v"
...
coverage save results/coverage_arbiter_487.ucdb
vcover report -assert -detail -output results/assertion_report_det_487.txt results/coverage_arbiter_487.ucdb
