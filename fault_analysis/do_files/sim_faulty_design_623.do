...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/30_1.v"
...
coverage save results/coverage_arbiter_623.ucdb
vcover report -assert -detail -output results/assertion_report_det_623.txt results/coverage_arbiter_623.ucdb
