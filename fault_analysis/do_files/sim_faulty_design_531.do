...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/24_5.v"
...
coverage save results/coverage_arbiter_531.ucdb
vcover report -assert -detail -output results/assertion_report_det_531.txt results/coverage_arbiter_531.ucdb
