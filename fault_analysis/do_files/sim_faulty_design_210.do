...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/154_3.v"
...
coverage save results/coverage_arbiter_210.ucdb
vcover report -assert -detail -output results/assertion_report_det_210.txt results/coverage_arbiter_210.ucdb
