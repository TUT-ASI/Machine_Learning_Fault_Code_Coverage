...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/139_4.v"
...
coverage save results/coverage_arbiter_123.ucdb
vcover report -assert -detail -output results/assertion_report_det_123.txt results/coverage_arbiter_123.ucdb
