...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/85_5.v"
...
coverage save results/coverage_arbiter_490.ucdb
vcover report -assert -detail -output results/assertion_report_det_490.txt results/coverage_arbiter_490.ucdb
