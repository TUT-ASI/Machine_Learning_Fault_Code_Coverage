...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/121_2.v"
...
coverage save results/coverage_arbiter_613.ucdb
vcover report -assert -detail -output results/assertion_report_det_613.txt results/coverage_arbiter_613.ucdb
