...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/84_0.v"
...
coverage save results/coverage_arbiter_345.ucdb
vcover report -assert -detail -output results/assertion_report_det_345.txt results/coverage_arbiter_345.ucdb
