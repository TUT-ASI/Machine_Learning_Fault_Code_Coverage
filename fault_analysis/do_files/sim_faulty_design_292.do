...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/20_1.v"
...
coverage save results/coverage_arbiter_292.ucdb
vcover report -assert -detail -output results/assertion_report_det_292.txt results/coverage_arbiter_292.ucdb
