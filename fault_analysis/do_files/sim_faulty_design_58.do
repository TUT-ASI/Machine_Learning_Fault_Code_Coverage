...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/57_0.v"
...
coverage save results/coverage_arbiter_58.ucdb
vcover report -assert -detail -output results/assertion_report_det_58.txt results/coverage_arbiter_58.ucdb
