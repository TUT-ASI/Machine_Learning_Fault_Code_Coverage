...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/64_3.v"
...
coverage save results/coverage_arbiter_402.ucdb
vcover report -assert -detail -output results/assertion_report_det_402.txt results/coverage_arbiter_402.ucdb
