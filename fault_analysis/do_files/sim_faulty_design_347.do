...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/57_4.v"
...
coverage save results/coverage_arbiter_347.ucdb
vcover report -assert -detail -output results/assertion_report_det_347.txt results/coverage_arbiter_347.ucdb
