...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/7_1.v"
...
coverage save results/coverage_arbiter_17.ucdb
vcover report -assert -detail -output results/assertion_report_det_17.txt results/coverage_arbiter_17.ucdb
