...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/45_3.v"
...
coverage save results/coverage_arbiter_295.ucdb
vcover report -assert -detail -output results/assertion_report_det_295.txt results/coverage_arbiter_295.ucdb
