...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/38_2.v"
...
coverage save results/coverage_arbiter_122.ucdb
vcover report -assert -detail -output results/assertion_report_det_122.txt results/coverage_arbiter_122.ucdb
