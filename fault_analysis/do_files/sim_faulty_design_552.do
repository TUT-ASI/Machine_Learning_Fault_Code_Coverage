...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/73_2.v"
...
coverage save results/coverage_arbiter_552.ucdb
vcover report -assert -detail -output results/assertion_report_det_552.txt results/coverage_arbiter_552.ucdb
