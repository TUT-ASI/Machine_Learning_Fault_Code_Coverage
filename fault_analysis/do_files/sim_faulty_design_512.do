...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/58_4.v"
...
coverage save results/coverage_arbiter_512.ucdb
vcover report -assert -detail -output results/assertion_report_det_512.txt results/coverage_arbiter_512.ucdb
