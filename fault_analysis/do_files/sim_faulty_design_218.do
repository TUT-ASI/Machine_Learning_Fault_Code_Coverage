...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/61_0.v"
...
coverage save results/coverage_arbiter_218.ucdb
vcover report -assert -detail -output results/assertion_report_det_218.txt results/coverage_arbiter_218.ucdb
