...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/66_3.v"
...
coverage save results/coverage_arbiter_108.ucdb
vcover report -assert -detail -output results/assertion_report_det_108.txt results/coverage_arbiter_108.ucdb
