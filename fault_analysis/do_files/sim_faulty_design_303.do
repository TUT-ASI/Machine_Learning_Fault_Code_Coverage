...
vlog -work work -cover bcesfx -vopt +incdir+ -cover bcesfx "Faulty_Designs/arbiter/70_2.v"
...
coverage save results/coverage_arbiter_303.ucdb
vcover report -assert -detail -output results/assertion_report_det_303.txt results/coverage_arbiter_303.ucdb
